...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      group: ""
        ...
        }, "\n        " + _toDisplayString(_ctx.$t('action.edit')) + "\n      ", 1 /* TEXT */) ]), _createVNode(_component_ModalDialog, {
        ...
        default: _withCtx(() => [
          _createElementVNode("div", {
            ...
            _createElementVNode("div", {
              ...
              _createElementVNode("h1", _hoisted_2, "\n            " + _toDisplayString(_ctx.$t('attachment.edit_title')) + "\n          ", 1 /* TEXT */),
              _createElementVNode("div", {
                flex: "",
                "flex-col": "",
                "gap-2": ""
