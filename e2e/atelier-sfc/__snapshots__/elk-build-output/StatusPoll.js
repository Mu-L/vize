      ...
      class: "poll-wrapper"
          ...
          onSubmit: _withModifiers(vote, ["prevent"])
            ...
            return (_openBlock(), _createElementBlock("label", {
              ...
              _createTextVNode("\n        "),
              _createTextVNode(_toDisplayString(option.title), 1 /* TEXT */),
              _createTextVNode("\n      ")
            ]))
          }), 128 /* KEYED_FRAGMENT */)), _createElementVNode("button", _hoisted_1, "\n        " + _toDisplayString(_ctx.$t('action.vote')) + "\n      ", 1 /* TEXT */) ])) : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(poll.options, (option, index) => {
            return (_openBlock(), _createElementBlock("div", {
              key: index,
              "py-1": "",
              relative: "",
        ...
        "gap-3": ""
          ...
          "flex-wrap": ""
              ...
              count: poll.votesCount
                ...
                _: 1 /* STABLE */
              })) : _createCommentVNode("v-if", true) ]) ]), (!poll.expired) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _createElementVNode("button", {
              "whitespace-nowrap": "",
              flex: "",
              "gap-1": "",
              "items-center": "",
              ...
              }, null, 2 /* CLASS */), _createTextVNode("\n          "), _createTextVNode(_toDisplayString(_ctx.$t('status.poll.update')), 1 /* TEXT */), _createTextVNode("\n        ") ]) ])) : _createCommentVNode("v-if", true) ]) ]))
}
}
