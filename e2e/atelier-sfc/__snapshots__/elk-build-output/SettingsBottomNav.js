...
return (_ctx: any,_cache: any) => {
  return (_openBlock(), _createElementBlock("section", { "space-y-2": "" }, [ _createElementVNode("h2", _hoisted_1, "\n      " + _toDisplayString(_ctx.$t('settings.interface.bottom_nav')) + "\n    ", 1 /* TEXT */), _createElementVNode("form", {
        "aria-labelledby": "interface-bn",
        "aria-describedby": "interface-bn-desc",
        onSubmit: _withModifiers(save, ["prevent"])
      }, [ _createElementVNode("p", _hoisted_2, "\n        " + _toDisplayString(_ctx.$t('settings.interface.bottom_nav_instructions')) + "\n      ", 1 /* TEXT */), _createTextVNode("\n      "), _createTextVNode("\n      "), _createElementVNode("div", {
          "aria-hidden": "true",
          flex: "~ gap4 wrap",
          "items-center": "",
          "select-settings": "",
          ...
          py4: ""
            ...
            return (_openBlock(), _createElementBlock("button", {
              ...
              _createTextVNode("\n          "),
              _createTextVNode(_toDisplayString(label ? _ctx.$t(label) : 'More menu'), 1 /* TEXT */),
              _createTextVNode("\n        ")
          ...
          sm: "~ justify-end flex-row"
            ...
            onClick: clear
          }, [ _hoisted_3, _createTextVNode("\n          "), _createTextVNode(_toDisplayString(_ctx.$t('action.clear')), 1 /* TEXT */), _createTextVNode("\n        ") ], 10 /* CLASS, PROPS */, ["disabled"]), _createElementVNode("button", {
            "btn-outline": "",
            "font-bold": "",
            py2: "",
            "full-w": "",
            ...
            type: "reset",
            onClick: reset
          }, [ _hoisted_4, _createTextVNode("\n          "), _createTextVNode(_toDisplayString(_ctx.$t('action.reset')), 1 /* TEXT */), _createTextVNode("\n        ") ]), _createElementVNode("button", {
            "btn-solid": "",
            "font-bold": "",
            py2: "",
            "full-w": "",
          ...
          }, [ _hoisted_5, _createTextVNode("\n          "), _createTextVNode(_toDisplayString(_ctx.$t('action.save')), 1 /* TEXT */), _createTextVNode("\n        ") ], 8 /* PROPS */, ["disabled"]) ]) ], 32 /* NEED_HYDRATION */) ]))
}
}
