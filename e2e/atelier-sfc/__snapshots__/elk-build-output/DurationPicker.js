...
return (_ctx: any,_cache: any) => {
  return (_openBlock(), _createElementBlock("div", {
      ...
      "gap-2": ""
        ...
        }, null, 2 /* CLASS */), [ [_vModelText, days.value] ]), _createTextVNode("\n      "), _createTextVNode(_toDisplayString(_ctx.$t('confirm.mute_account.days', days.value === '' ? 0 : days.value)), 1 /* TEXT */), _createTextVNode("\n    ") ]), _createElementVNode("label", {
        flex: "",
        "items-center": "",
        "gap-2": ""
      }, [ _withDirectives(_createElementVNode("input", {
          ...
          "input-base": "",
          class: _normalizeClass(!isValid.value ? 'input-error' : null)
        }, null, 2 /* CLASS */), [ [_vModelText, hours.value] ]), _createTextVNode("\n      "), _createTextVNode(_toDisplayString(_ctx.$t('confirm.mute_account.hours', hours.value === '' ? 0 : hours.value)), 1 /* TEXT */), _createTextVNode("\n    ") ]), _createElementVNode("label", {
        flex: "",
        "items-center": "",
        "gap-2": ""
      }, [ _withDirectives(_createElementVNode("input", {
          ...
          "input-base": "",
          class: _normalizeClass(!isValid.value ? 'input-error' : null)
        }, null, 2 /* CLASS */), [ [_vModelText, minutes.value] ]), _createTextVNode("\n      "), _createTextVNode(_toDisplayString(_ctx.$t('confirm.mute_account.minute', minutes.value === '' ? 0 : minutes.value)), 1 /* TEXT */), _createTextVNode("\n    ") ]) ]))
}
}
