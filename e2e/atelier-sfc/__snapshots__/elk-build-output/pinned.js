...
return (_ctx: any,_cache: any) => {
  ...
  const _component_TimelinePinned = _resolveComponent("TimelinePinned")
  ...
  return (_openBlock(), _createBlock(_component_MainContent, null, {
      title: _withCtx(() => [
        _createVNode(_component_MainTitle, {
          ...
          default: _withCtx(() => [
            _createTextVNode("\n        "),
            _createTextVNode(_toDisplayString(_unref(t)('account.pinned')), 1 /* TEXT */),
            _createTextVNode("\n      ")
          ]),
          _: 1 /* STABLE */
        })
      ...
      default: _withCtx(() => [
        (_ctx.isHydrated && _ctx.currentUser)
          ? (_openBlock(), _createBlock(_component_TimelinePinned, { key: 0 }))
