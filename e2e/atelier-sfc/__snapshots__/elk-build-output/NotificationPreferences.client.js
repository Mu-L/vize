...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    show: { type: Boolean as PropType<boolean>, required: false }
  },
  setup(__props) {
          ...
          default: _withCtx(() => [
            (__props.show)
              ? (_openBlock(), _createElementBlock("div", {
                ...
                _createElementVNode("h3", _hoisted_1, "\n          " + _toDisplayString(_ctx.$t('settings.notifications.push_notifications.label')) + "\n        ", 1 /* TEXT */),
                (_unref(isSupported))
                    ...
                    (_unref(isSubscribed))
                      ? (_openBlock(), _createElementBlock("div", {
                        ...
                        _createElementVNode("form", {
                          ...
                          _createElementVNode("p", _hoisted_2, "\n                " + _toDisplayString(_ctx.$t('settings.notifications.push_notifications.instructions')) + "\n              ", 1 /* TEXT */),
                          ...
                          _createElementVNode("div", {
                            ...
                            _createElementVNode("button", {
                              ...
                              _createTextVNode("\n                  "),
                              _createTextVNode(_toDisplayString(_ctx.$t('settings.notifications.push_notifications.save_settings')), 1 /* TEXT */),
                              _createTextVNode("\n                ")
                            ...
                            _createElementVNode("button", {
                              ...
                              _hoisted_4,
                              _createTextVNode("\n                  "),
                              _createTextVNode(_toDisplayString(_ctx.$t('settings.notifications.push_notifications.undo_settings')), 1 /* TEXT */),
                              _createTextVNode("\n                ")
                            ], 10 /* CLASS, PROPS */, ["disabled"])
                          ])
                        ], 32 /* NEED_HYDRATION */),
                        _createElementVNode("form", {
                          ...
                          _createElementVNode("button", {
                            ...
                            _createTextVNode("\n                "),
                            _createTextVNode(_toDisplayString(_ctx.$t('settings.notifications.push_notifications.unsubscribe')), 1 /* TEXT */),
                            _createTextVNode("\n              ")
                          ], 10 /* CLASS, PROPS */, ["disabled"])
                        ], 32 /* NEED_HYDRATION */)
                      ]))
                  ...
                  : (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("p", _hoisted_7, "\n            " + _toDisplayString(_ctx.$t('settings.notifications.push_notifications.unsupported')) + "\n          ", 1 /* TEXT */)
                  ]))
              ]))
