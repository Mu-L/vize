...
export default /*@__PURE__*/_defineComponent({
  __name: 'TagCard',
  props: {
    tag: { type: null as unknown as PropType<mastodon.v1.Tag>, required: true }
  },
  setup(__props) {
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      onKeydown: _withKeys(onclick, ["enter"])
        ...
        flex: "",
        "flex-gap-2": ""
      }, [ _createVNode(_component_TagActionButton, { tag: __props.tag }), _createElementVNode("div", null, [ _createElementVNode("h4", {
            flex: "",
            "items-center": "",
            "text-size-base": "",
            "leading-normal": "",
            ...
            "ws-pre-wrap": ""
              ...
              "ws-pre-wrap": "",
              "break-all": ""
            })) : _createCommentVNode("v-if", true) ]) ]), (__props.tag.history) ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          flex: "",
          "items-center": ""
        }, [ _createVNode(_component_CommonTrendingCharts, { history: __props.tag.history }) ])) : _createCommentVNode("v-if", true) ], 32 /* NEED_HYDRATION */))
}
}
