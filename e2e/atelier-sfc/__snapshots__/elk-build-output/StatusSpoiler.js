...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    enabled: { type: Boolean as PropType<boolean>, required: false },
    filter: { type: Boolean as PropType<boolean>, required: false },
    isDM: { type: Boolean as PropType<boolean>, required: false },
    sensitiveNonSpoiler: { type: Boolean as PropType<boolean>, required: false }
  },
  setup(__props) {
          ...
          "items-start": ""
            ...
            mt: "-4.5"
              ...
              onClick: _cache[0] || (_cache[0] = ($event: any) => (_unref(toggleContent)()))
                  ...
                  key: 1,
                  "i-ri:eye-close-line": ""
                })), _createTextVNode("\n        "), _createTextVNode(_toDisplayString(showContent.value ? _ctx.$t('status.spoiler_show_less') : _ctx.$t(getToggleText())), 1 /* TEXT */), _createTextVNode("\n      ") ], 10 /* CLASS, PROPS */, ["bg", "aria-expanded"]) ], 8 /* PROPS */, ["mb"]) ])) : _createCommentVNode("v-if", true), (!_unref(hideContent) || showContent.value) ? (_openBlock(), _createElementBlock("slot", { key: 0 })) : _createCommentVNode("v-if", true) ], 64 /* STABLE_FRAGMENT */))
}
}
