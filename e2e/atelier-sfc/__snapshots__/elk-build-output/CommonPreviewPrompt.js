...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      "of-hidden": "",
      flex: "~ col gap-3"
    }, [ _createElementVNode("h2", _hoisted_1, "\n      " + _toDisplayString(_ctx.$t('help.build_preview.title')) + "\n    ", 1 /* TEXT */), _createElementVNode("p", null, [ _createVNode(_component_i18n_t, { keypath: "help.build_preview.desc1" }, {
          default: _withCtx(() => [
          ...
          _: 1 /* STABLE */
        }) ]), _createElementVNode("p", null, _toDisplayString(_ctx.$t('help.build_preview.desc2')), 1 /* TEXT */), _createElementVNode("p", _hoisted_2, "\n      " + _toDisplayString(_ctx.$t('help.build_preview.desc3')) + "\n    ", 1 /* TEXT */), _hoisted_3 ]))
}
}
