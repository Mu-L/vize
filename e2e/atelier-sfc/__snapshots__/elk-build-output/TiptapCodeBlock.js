...
import { Fragment as _Fragment, openBlock as _openBlock, createBlock as _createBlock, createElementBlock as _createElementBlock, createVNode as _createVNode, createElementVNode as _createElementVNode, withDirectives as _withDirectives, renderList as _renderList, toDisplayString as _toDisplayString, withCtx as _withCtx, unref as _unref, vModelSelect as _vModelSelect } from "vue"
      ...
      default: _withCtx(() => [
        _createElementVNode("div", {
          ...
          _withDirectives(_createElementVNode("select", {
            ...
            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_unref(languages), (language, index) => {
              return (_openBlock(), _createElementBlock("option", {
                key: index,
                value: language
              }, "\n          " + _toDisplayString(language) + "\n        ", 9 /* TEXT, PROPS */, ["value"]))
            }), 128 /* KEYED_FRAGMENT */))
          ], 512 /* NEED_PATCH */), [
