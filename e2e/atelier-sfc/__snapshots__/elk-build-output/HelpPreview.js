...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      relative: ""
        ...
        mxa: "",
        class: "rtl-flip"
      }, null, 8 /* PROPS */, ["alt", "src"]), _createElementVNode("h1", _hoisted_2, "\n      " + _toDisplayString(_ctx.$t('help.title')) + "\n    ", 1 /* TEXT */), _createElementVNode("p", null, "\n      " + _toDisplayString(_ctx.$t('help.desc_para1')) + "\n    ", 1 /* TEXT */), _createElementVNode("p", null, [ _createElementVNode("b", _hoisted_3, _toDisplayString(_ctx.$t('help.desc_highlight')), 1 /* TEXT */), _createTextVNode("\n      "), _createTextVNode(_toDisplayString(_ctx.$t('help.desc_para2')), 1 /* TEXT */), _createTextVNode("\n    ") ]), _createElementVNode("p", null, [ _createTextVNode("\n      "), _createTextVNode(_toDisplayString(_ctx.$t('help.desc_para4')), 1 /* TEXT */), _createTextVNode("\n      "), _createVNode(_component_NuxtLink, {
          "font-bold": "",
          "text-primary": "",
          ...
          _: 1 /* STABLE */
        }), _createTextVNode("\n      "), _createTextVNode(_toDisplayString(_ctx.$t('help.desc_para6')), 1 /* TEXT */), _createTextVNode("\n    ") ]), _createVNode(_component_NuxtLink, {
        "hover:text-primary": "",
      ...
      }, "\n      " + _toDisplayString(_ctx.$t('action.enter_app')) + "\n    ", 1 /* TEXT */) ]))
}
}
