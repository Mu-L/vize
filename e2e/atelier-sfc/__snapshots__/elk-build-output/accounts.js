        ...
        group: ""
          ...
          "gap-3": ""
            ...
            "ps-4": ""
              ...
              onKeydown: [_withKeys(_withModifiers(($event: any) => (inputRef.value?.blur()), ["prevent"]), ["esc"]), _withKeys(_withModifiers(() => {}, ["prevent"]), ["enter"])]
                ...
                "btn-action-icon": "",
                "text-secondary": "",
                onClick: _cache[1] || (_cache[1] = ($event: any) => { query = ''; inputRef?.focus() })
          ...
          "pointer-events-none": ""
            ...
            class: _normalizeClass(results.value.length === 0 ? 'py2' : null)
                ...
                "text-sm": "",
                "text-secondary": ""
              }, "\n          " + _toDisplayString(_ctx.$t('list.search_following_desc')) + "\n        ", 1 /* TEXT */)) : (!_unref(loading)) ? (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [ (results.value.length > 0) ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(results.value, (result, i) => {
                      ...
                      "text-sm": "",
                      "text-secondary": ""
                    }, "\n            " + _toDisplayString(_ctx.$t('search.search_empty')) + "\n          ", 1 /* TEXT */)) ], 64 /* STABLE_FRAGMENT */)) : (_openBlock(), _createElementBlock("div", { key: 2 }, [ _createVNode(_component_SearchResultSkeleton), _createVNode(_component_SearchResultSkeleton), _createVNode(_component_SearchResultSkeleton) ])) ], 2 /* CLASS */) ]) ], 512 /* NEED_PATCH */), _createVNode(_component_CommonPaginator, {
        ref: paginatorRef,
