...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      "flex-col": ""
          ...
          }) ])) : _createCommentVNode("v-if", true), _createVNode(_resolveDynamicComponent(hasHeader.value ? 'button' : 'div'), {
        border: "b base",
        "z-1": "",
        ...
        "gap-4": ""
            ...
            "justify-between": ""
              ...
              "justify-start": ""
                ...
                "items-center": ""
                  ...
                  onRemoveNote: _cache[2] || (_cache[2] = () => { isEditingPersonalNote.value = false; personalNoteDraft.value = '' })
                }), (!_unref(isSelf) && _unref(relationship)?.following) ? (_openBlock(), _createBlock(_component_CommonTooltip, {
                    key: 0,
                    ...
                    _: 1 /* STABLE */
                  })) : _createCommentVNode("v-if", true), _createVNode(_component_CommonTooltip, { content: _ctx.$t('list.modify_account') }, {
                  default: _withCtx(() => [
                    (!_unref(isSelf) && _unref(relationship)?.following)
                      ? (_openBlock(), _createBlock(_component_VDropdown, { key: 0 }, {
                        popper: _withCtx(() => [
                          _createVNode(_component_ListLists, { "user-id": __props.account.id })
                        ]),
                        default: _withCtx(() => [
                          _createElementVNode("button", {
            ...
            pt2: ""
              ...
              "flex-wrap": ""
                ...
                "sm:text-2xl": "",
                "text-xl": ""
              }), (__props.account.locked) ? (_openBlock(), _createBlock(_component_AccountLockIndicator, {
                  key: 0,
                  "show-label": ""
              ...
              "mt-1": ""
                  ...
                  key: 0,
                  account: __props.account
                })) : _createCommentVNode("v-if", true) ]) ]) ]), (isEditingPersonalNote.value || (_unref(relationship)?.note && _unref(relationship).note.length > 0)) ? (_openBlock(), _createElementBlock("label", {
            key: 0,
            "space-y-2": "",
            "pb-4": "",
            block: "",
            border: "b base"
              ...
              "space-x-2": "",
              "flex-v-center": ""
            }, [ _hoisted_4, _createElementVNode("p", _hoisted_5, "\n            " + _toDisplayString(_ctx.$t('account.profile_personal_note')) + "\n          ", 1 /* TEXT */), _createElementVNode("p", {
                "text-secondary": "",
                "text-sm": "",
                class: _normalizeClass({ 'text-orange': personalNoteDraft.value.length > (personalNoteMaxLength - 100) })
              }, "\n            " + _toDisplayString(personalNoteDraft.value.length) + " / " + _toDisplayString(personalNoteMaxLength) + "\n          ", 3 /* TEXT, CLASS */) ]), _createElementVNode("div", { "position-relative": "" }, [ _createElementVNode("div", {
                "input-base": "",
                "min-h-10ex": "",
                "whitespace-pre-wrap": "",
                "opacity-0": "",
                class: _normalizeClass({ 'trailing-newline': personalNoteDraft.value.endsWith('\n') })
              }, "\n            " + _toDisplayString(personalNoteDraft.value) + "\n          ", 3 /* TEXT, CLASS */), _withDirectives(_createElementVNode("textarea", {
            ...
            }) ])) : _createCommentVNode("v-if", true), (namedFields.value.length) ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            flex: "~ col wrap gap1"
            ...
            }), 128 /* KEYED_FRAGMENT */)) ])) : _createCommentVNode("v-if", true), _createVNode(_component_AccountPostsFollowers, { account: __props.account }) ]) ]))
}
}
