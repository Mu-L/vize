...
return (_ctx: any,_cache: any) => {
  ...
  const _component_TimelineDomainBlocks = _resolveComponent("TimelineDomainBlocks")

  return (_openBlock(), _createBlock(_component_MainContent, { back: "" }, {
      title: _withCtx(() => [
        _createVNode(_component_MainTitle, null, {
          default: _withCtx(() => [
            _createTextVNode(_toDisplayString(_ctx.$t('nav.blocked_domains')), 1 /* TEXT */)
          ]),
          _: 1 /* STABLE */
        })
      ]),
      default: _withCtx(() => [
        (_ctx.isHydrated)
          ? (_openBlock(), _createBlock(_component_TimelineDomainBlocks, { key: 0 }))
