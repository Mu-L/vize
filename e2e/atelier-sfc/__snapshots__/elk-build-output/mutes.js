...
return (_ctx: any,_cache: any) => {
  ...
  const _component_TimelineMutes = _resolveComponent("TimelineMutes")

  return (_openBlock(), _createBlock(_component_MainContent, { back: "" }, {
      title: _withCtx(() => [
        _createVNode(_component_MainTitle, null, {
          default: _withCtx(() => [
            _createTextVNode(_toDisplayString(_ctx.$t('nav.muted_users')), 1 /* TEXT */)
          ]),
          _: 1 /* STABLE */
        })
      ]),
      default: _withCtx(() => [
        (_ctx.isHydrated)
          ? (_openBlock(), _createBlock(_component_TimelineMutes, { key: 0 }))
