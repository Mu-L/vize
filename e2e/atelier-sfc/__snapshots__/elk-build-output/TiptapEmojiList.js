...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    items: { type: null as unknown as PropType<(CustomEmoji | Emoji)[]>, required: true },
    command: { type: null as unknown as PropType<CommandHandler<any>>, required: true },
    isPending: { type: Boolean as PropType<boolean>, required: false }
  },
        ...
        "max-w-50": ""
            ...
            "animate-pulse": ""
              ...
              return (_openBlock(), _createBlock(_component_CommonScrollIntoView, {
                ...
                _createVNode(_component_SearchEmojiInfo, { emoji: item })
              ], 10 /* CLASS, PROPS */, ["active"]))
