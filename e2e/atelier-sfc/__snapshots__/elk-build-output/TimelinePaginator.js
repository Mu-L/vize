...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    paginator: { type: null as unknown as PropType<mastodon.Paginator<mastodon.v1.Status[], mastodon.rest.v1.ListAccountStatusesParams>>, required: true },
    ...
    followedTags: { type: Array as PropType<mastodon.v1.Tag[]>, required: false, default: [] },
    preprocess: { type: Array as PropType<(items: mastodon.v1.Status[]) => mastodon.v1.Status[]>, required: false },
