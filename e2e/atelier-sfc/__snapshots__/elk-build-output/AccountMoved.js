  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      p4: ""
        ...
        "justify-center": ""
          ...
          link: false
        }), _createTextVNode("\n      "), _createTextVNode(_toDisplayString(_ctx.$t('account.moved_title')), 1 /* TEXT */), _createTextVNode("\n    ") ]), _createElementVNode("div", { flex: "" }, [ _createVNode(_component_NuxtLink, { to: _ctx.getAccountRoute(__props.account.moved) }, {
          default: _withCtx(() => [
            _createVNode(_component_AccountInfo, { account: __props.account.moved })
          ]),
          _: 1 /* STABLE */
