      ...
      group: ""
        ...
        "focus-within:box-shadow-outline": ""
          ...
          onKeypress: _withKeys(activate, ["enter"])
            ...
            "btn-action-icon": "",
            "text-secondary": "",
            onClick: _cache[1] || (_cache[1] = ($event: any) => { query = ''; input?.focus() })
        ...
        "pointer-events-none": ""
          ...
          class: _normalizeClass(results.value.length === 0 ? 'py2' : null)
              ...
              "text-secondary": ""
                    ...
                    "text-sm": "",
                    "text-secondary": ""
                  }, "\n            " + _toDisplayString(_unref(t)('search.search_empty')) + "\n          ", 1 /* TEXT */)) ], 64 /* STABLE_FRAGMENT */)) : (_openBlock(), _createElementBlock("div", { key: 2 }, [ _createVNode(_component_SearchResultSkeleton), _createVNode(_component_SearchResultSkeleton), _createVNode(_component_SearchResultSkeleton) ])) ], 2 /* CLASS */) ]) ], 512 /* NEED_PATCH */))
}
}
