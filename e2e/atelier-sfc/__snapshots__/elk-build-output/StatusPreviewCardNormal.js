...
const providerName = computed(() => __props.card.providerName ? __props.card.providerName : punycode.toUnicode(new URL(card.url).hostname))
        ...
        _createElementVNode("div", {
          ...
          (__props.card.image)
            ...
            __props.root ? 'rounded-lg' : '',
              ...
              _createElementVNode("div", {
                class: _normalizeClass(_unref(cardTypeIconMap)[__props.card.type]),
                w: "30%",
                h: "30%",
                "text-secondary": ""
              }, null, 2 /* CLASS */)
