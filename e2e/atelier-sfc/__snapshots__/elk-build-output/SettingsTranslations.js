...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", null, [ _createVNode(_component_CommonCheckbox, {
      ...
      }), (!_unref(userSettings).preferences.hideTranslation) ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "mt-1 ms-2"
        }, [ _createElementVNode("p", _hoisted_1, "\n        " + _toDisplayString(_ctx.$t('settings.language.translations.hide_specific')) + "\n      ", 1 /* TEXT */), _createElementVNode("div", { class: "ms-4" }, [ _createElementVNode("ul", null, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_unref(userSettings).disabledTranslationLanguages, (langCode) => {
                ...
                class: "select-settings"
                  ...
                  selected: "",
                  value: null
                }, "\n              " + _toDisplayString(_ctx.$t('settings.language.translations.choose_language')) + "\n            ", 9 /* TEXT, PROPS */, ["value"]), (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(availableOptions.value, (availableOption) => {
                  return (_openBlock(), _createElementBlock("option", {
                    key: availableOption.code,
                    value: availableOption.code
                  }, "\n              " + _toDisplayString(availableOption.nativeName) + "\n            ", 9 /* TEXT, PROPS */, ["value"]))
              ...
              }, "\n            " + _toDisplayString(_ctx.$t('settings.language.translations.add')) + "\n          ", 1 /* TEXT */) ]) ]) ])) : _createCommentVNode("v-if", true) ]))
}
}
