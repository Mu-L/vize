...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    history: { type: Array as PropType<mastodon.v1.TagHistory[]>, required: false },
    width: { type: Number as PropType<number>, required: false, default: 60 },
    height: { type: Number as PropType<number>, required: false, default: 40 }
  },
  setup(__props) {
