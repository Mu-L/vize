  ...
  return (_openBlock(), _createElementBlock("form", {
      ...
      onSubmit: _cache[0] || (_cache[0] = _withModifiers((...args) => (oauth && oauth(...args)), ["prevent"]))
        ...
        "gap-x-2": ""
          ...
          alt: _ctx.$t('app_logo'),
          class: "rtl-flip"
        }, null, 8 /* PROPS */, ["src", "alt"]), _createElementVNode("div", _hoisted_1, "\n        " + _toDisplayString(_ctx.$t('action.sign_in')) + "\n      ", 1 /* TEXT */) ]), _createElementVNode("div", null, "\n      " + _toDisplayString(_ctx.$t('user.server_address_label')) + "\n    ", 1 /* TEXT */), _createElementVNode("div", {
            ...
            default: _withCtx(() => [
              (_unref(displayError))
                ? (_openBlock(), _createElementBlock("p", {
                  ...
                  "text-red-600": "",
                  "dark:text-red-400": ""
                }, "\n            " + _toDisplayString(_ctx.$t('error.sign_in_error')) + "\n          ", 1 /* TEXT */))
        ...
        disabled: !_unref(server) || _unref(busy)
            ...
            class: "rtl-flip"
          })), _createTextVNode("\n      "), _createTextVNode(_toDisplayString(_ctx.$t('action.sign_in')), 1 /* TEXT */), _createTextVNode("\n    ") ], 8 /* PROPS */, ["disabled"]) ], 32 /* NEED_HYDRATION */))
}
}
