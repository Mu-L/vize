...
export default /*@__PURE__*/Object.assign({
  ...
  props: {
    ...
    closeByMask: { type: Boolean as PropType<boolean>, required: false, default: true },
    useVIf: { type: Boolean as PropType<boolean>, required: false, default: true },
    keepAlive: { type: Boolean as PropType<boolean>, required: false, default: false },
    dialogLabelledBy: { type: String as PropType<string>, required: false },
    focusFirstElement: { type: Boolean as PropType<boolean>, required: false, default: true },
...
return (_ctx: any,_cache: any) => {
  return (_openBlock(), _createBlock(_Teleport, { to: "body" }, [ _createTextVNode("\n    "), _createTextVNode("\n    "), _createVNode(_Transition, {
        name: "dialog-visible",
