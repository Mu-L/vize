...
const _hoisted_1 = /*#__PURE__*/ _createElementVNode("div", { "i-ri:bookmark-line": "true" })

export default /*@__PURE__*/_defineComponent({
  __name: 'Bookmark',
  props: {
    activeClass: { type: String as PropType<string>, required: true }
  },
  setup(__props) {
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createBlock(_component_NuxtLink, {
      to: "/bookmarks",
      "aria-label": _ctx.$t('nav.bookmarks'),
