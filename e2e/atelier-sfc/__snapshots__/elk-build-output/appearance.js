        ...
        _createElementVNode("form", {
          ...
          (account.value)
            ? (_openBlock(), _createElementBlock("div", { key: 0 }, [
              ...
              _createElementVNode("div", { px4: "" }, [
                ...
                _createVNode(_component_AccountHandle, { account: account.value })
              ])
            ]))
          ...
          _createElementVNode("div", {
            ...
            _createElementVNode("label", {
              ...
              _createElementVNode("p", _hoisted_1, "\n            " + _toDisplayString(_ctx.$t('settings.profile.appearance.display_name')) + "\n          ", 1 /* TEXT */),
              _withDirectives(_createElementVNode("input", {
            ...
            _createElementVNode("label", {
              ...
              _createElementVNode("p", _hoisted_2, "\n            " + _toDisplayString(_ctx.$t('settings.profile.appearance.bio')) + "\n          ", 1 /* TEXT */),
            ...
            _createElementVNode("div", {
              ...
              _createElementVNode("button", {
                ...
                _hoisted_3,
                _createTextVNode("\n            "),
                _createTextVNode(_toDisplayString(_ctx.$t('action.reset')), 1 /* TEXT */),
                _createTextVNode("\n          ")
              ]),
