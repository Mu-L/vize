...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    items: { type: Array as PropType<mastodon.v1.Tag[]>, required: true },
    command: { type: Object as PropType<CommandHandler<{ id: string }>>, required: true },
        ...
        "max-h-100": ""
            ...
            "animate-pulse": ""
              ...
              return (_openBlock(), _createBlock(_component_CommonScrollIntoView, {
                ...
                _createVNode(_component_SearchHashtagInfo, { hashtag: item })
