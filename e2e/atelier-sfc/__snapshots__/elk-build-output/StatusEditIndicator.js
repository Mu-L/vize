...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    inline: { type: Boolean as PropType<boolean>, required: true }
  },
  setup(__props) {
...
return (_ctx: any,_cache: any) => {
  ...
  return (editedAt.value)
      ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [ (__props.inline) ? (_openBlock(), _createBlock(_component_CommonTooltip, {
            ...
            _: 1 /* STABLE */
          })) : (_openBlock(), _createBlock(_component_CommonDropdown, { key: 1 }, {
            popper: _withCtx(() => [
              _createElementVNode("div", {
                "text-sm": "",
                p2: ""
              }, [
                _createElementVNode("div", _hoisted_1, "\n            " + _toDisplayString(_ctx.$t('status.edited', [_unref(formatted)])) + "\n          ", 1 /* TEXT */),
                _createVNode(_component_StatusEditHistory, { status: __props.status })
              ])
            ]),
            default: _withCtx(() => [
