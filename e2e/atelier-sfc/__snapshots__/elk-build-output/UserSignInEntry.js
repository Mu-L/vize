  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      hidden: ""
          ...
          "text-sm": ""
            ...
            _: 1 /* STABLE */
          }) ])) : _createCommentVNode("v-if", true), _createElementVNode("p", _hoisted_1, "\n      " + _toDisplayString(_ctx.$t(_unref(singleInstanceServer) ? 'user.single_instance_sign_in_desc' : 'user.sign_in_desc')) + "\n    ", 1 /* TEXT */), (_unref(singleInstanceServer)) ? (_openBlock(), _createElementBlock("button", {
          key: 0,
          flex: "~ row",
          "gap-x-2": "",
          "items-center": "",
          ...
          onClick: _cache[0] || (_cache[0] = ($event: any) => (_unref(oauth)()))
              ...
              class: "rtl-flip"
            })), _createTextVNode("\n      "), _toDisplayString(_ctx.$t('action.sign_in')), _createTextVNode("\n    ") ])) : (_openBlock(), _createElementBlock("button", {
          key: 1,
          "btn-solid": "",
          "rounded-3": "",
          "text-center": "",
        ...
        }, "\n      " + _toDisplayString(_ctx.$t('action.sign_in')) + "\n    ", 1 /* TEXT */)) ]))
}
}
