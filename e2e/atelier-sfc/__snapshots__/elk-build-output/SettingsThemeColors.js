...
import { Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, createElementVNode as _createElementVNode, renderList as _renderList, toDisplayString as _toDisplayString, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle } from "vue"
...
return (_ctx: any,_cache: any) => {
  return (_openBlock(), _createElementBlock("section", { "space-y-2": "" }, [ _createElementVNode("h2", _hoisted_1, "\n      " + _toDisplayString(_ctx.$t('settings.interface.theme_color')) + "\n    ", 1 /* TEXT */), _createElementVNode("div", {
        ...
        "aria-labelledby": "interface-tc"
          ...
          }, 14 /* CLASS, STYLE, PROPS */, ["aria-pressed", "title"]))
        }), 128 /* KEYED_FRAGMENT */)) ]) ]))
}
}
