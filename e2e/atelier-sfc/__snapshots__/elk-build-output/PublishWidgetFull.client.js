        ...
        "h-8": ""
                      ...
                      _createElementVNode("div", {
                        ...
                        (firstDraftItemOf(drafts).lastUpdated)
                          ? (_openBlock(), _createElementBlock("span", {
                            ...
                            "text-secondary": "",
                            "text-sm": ""
                          }, "\n                    &middot; " + _toDisplayString(_unref(formatTimeAgo)(new Date(firstDraftItemOf(drafts).lastUpdated), _unref(timeAgoOptions))) + "\n                  ", 1 /* TEXT */))
                          : _createCommentVNode("v-if", true)
                      ]),
                      _createElementVNode("div", _hoisted_2, "\n                  " + _toDisplayString(_ctx.htmlToText(firstDraftItemOf(drafts).params.status).slice(0, 50)) + "\n                ", 1 /* TEXT */)
                    ])
                  ], 8 /* PROPS */, ["replace", "to"]))
                }), 128 /* KEYED_FRAGMENT */))
              ])
            ...
            default: _withCtx(() => [
              _createElementVNode("button", {
                ...
                _createTextVNode("\n          "),
                _createTextVNode(_toDisplayString(_ctx.$t('compose.drafts', nonEmptyDrafts.value.length, { named: { v: _unref(formatNumber)(nonEmptyDrafts.value.length) } })), 1 /* TEXT */),
                _createTextVNode(" \n          "),
                _hoisted_1
              ])
            ]),
