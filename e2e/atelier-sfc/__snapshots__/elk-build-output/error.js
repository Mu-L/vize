...
export default /*@__PURE__*/_defineComponent({
  __name: 'error',
  props: {
    error: { type: null as unknown as PropType<Partial<NuxtError>>, required: true }
  },
  setup(__props) {
            ...
            default: _withCtx(() => [
              _renderSlot(_ctx.$slots, "default", {}, () => [
                _createElementVNode("form", {
                  ...
                  _hoisted_1,
                  _createElementVNode("div", _hoisted_2, "\n            " + _toDisplayString(_unref(message)) + "\n          ", 1 /* TEXT */),
                  _createElementVNode("button", {
                    ...
                    _createTextVNode("\n            "),
                    _createTextVNode(_toDisplayString(state.value === 'reloading' ? 'Reloading' : 'Reload'), 1 /* TEXT */),
                    _createTextVNode("\n          ")
                  ], 8 /* PROPS */, ["disabled"])
                ], 32 /* NEED_HYDRATION */)
              ])
