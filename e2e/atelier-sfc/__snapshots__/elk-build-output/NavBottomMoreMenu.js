            ...
            _createElementVNode("div", {
              ...
              _createElementVNode("div", { flex: "~ col gap2" }, [
                ...
                _createElementVNode("button", {
                  ...
                  _hoisted_3,
                  _createTextVNode("\n              "),
                  _createTextVNode(_toDisplayString(_unref(colorMode).value === 'light' ? _ctx.$t('menu.toggle_theme.dark') : _ctx.$t('menu.toggle_theme.light')), 1 /* TEXT */),
                  _createTextVNode("\n            ")
                ]),
                _createTextVNode("\n\n            "),
                _createTextVNode("\n            "),
                _createElementVNode("button", {
                  ...
                  _createTextVNode("\n              "),
                  _createTextVNode(_toDisplayString(_ctx.$t('nav.zen_mode')), 1 /* TEXT */),
                  _createTextVNode("\n            ")
                ], 8 /* PROPS */, ["aria-label"])
              ])
            ], 6 /* CLASS, STYLE */)
