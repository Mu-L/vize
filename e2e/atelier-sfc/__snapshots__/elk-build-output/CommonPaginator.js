...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    paginator: { type: null as unknown as PropType<mastodon.Paginator<T[], O>>, required: true },
    keyProp: { type: null as unknown as PropType<keyof T>, required: false, default: 'id' },
    virtualScroller: { type: Boolean as PropType<boolean>, required: false, default: false },
    stream: { type: null as unknown as PropType<mastodon.streaming.Subscription>, required: false },
    eventType: { type: String as PropType<'update' | 'notification'>, required: false },
    preprocess: { type: Object as PropType<(items: (U | T)[]) => U[]>, required: false },
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", null, [ (_unref(prevItems).length) ? (_openBlock(), _createElementBlock("slot", _mergeProps({ number: _unref(prevItems).length, update: _unref(update) }, {
        ...
        items: _unref(items)
            ...
            _: 1 /* STABLE */
          })) : (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(_unref(items), (item, index) => {
            ...
            }), 256 /* UNKEYED_FRAGMENT */)) ], 64 /* STABLE_FRAGMENT */)) ]), _createElementVNode("div", { ref: endAnchor }, null, 512 /* NEED_PATCH */), (_unref(state) === 'loading') ? (_openBlock(), _createElementBlock("slot", {
          key: 0,
          name: "loading"
            ...
            name: "done",
            items: _unref(items)
          }, [ _createElementVNode("div", _hoisted_1, "\n        " + _toDisplayString(_unref(t)(typeof __props.endMessage === 'string' && _unref(items).length <= 0 ? __props.endMessage : 'common.end_of_list')) + "\n      ", 1 /* TEXT */) ])) : (_unref(state) === 'error') ? (_openBlock(), _createElementBlock("div", {
            key: 2,
            p5: "",
            "text-secondary": ""
          }, "\n      " + _toDisplayString(_unref(t)('common.error')) + ": " + _toDisplayString(_unref(error)) + "\n    ", 1 /* TEXT */)) : _createCommentVNode("v-if", true), (_unref(state) !== 'loading' && _unref(state) !== 'done' && !_unref(canLoadMore)) ? (_openBlock(), _createElementBlock("button", {
          key: 0,
          flex: "~ gap-1 center",
          "w-full": "",
          "my-6": "",
        ...
        }, [ _hoisted_2, _createTextVNode("\n      "), _toDisplayString(_ctx.$t('timeline.load_more')), _createTextVNode("\n    ") ])) : _createCommentVNode("v-if", true) ]))
}
}
