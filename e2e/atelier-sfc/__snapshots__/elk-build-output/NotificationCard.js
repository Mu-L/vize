...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    notification: { type: null as unknown as PropType<Notification>, required: true }
  },
  setup(__props) {
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("article", {
      ...
      relative: ""
          ...
          default: _withCtx(() => [
            _createElementVNode("div", {
              ...
              _createElementVNode("span", { "ws-nowrap": "" }, [
                _createTextVNode("\n            "),
                _createTextVNode(_toDisplayString(_ctx.$t('notification.followed_you')), 1 /* TEXT */),
                _createTextVNode("\n            "),
          ...
          _: 1 /* STABLE */
        })) : (__props.notification.type === 'admin.sign_up') ? (_openBlock(), _createBlock(_component_NuxtLink, {
            key: 1,
            to: _ctx.getAccountRoute(__props.notification.account)
          }, {
            default: _withCtx(() => [
              _createElementVNode("div", {
                ...
                _createElementVNode("span", null, [
                  _createTextVNode(_toDisplayString(_ctx.$t("notification.signed_up")), 1 /* TEXT */),
                  _createTextVNode("\n            "),
                  _createElementVNode("time", {
                    "text-secondary": "",
                    datetime: __props.notification.createdAt
            ...
            _: 1 /* STABLE */
          })) : (__props.notification.type === 'admin.report') ? (_openBlock(), _createBlock(_component_NuxtLink, {
            key: 2,
            ...
            _: 1 /* STABLE */
          })) : (__props.notification.type === 'follow_request') ? (_openBlock(), _createElementBlock(_Fragment, { key: 3 }, [ _createElementVNode("div", {
              flex: "",
              "px-3": "",
              "py-2": ""
                ...
                "me-1": "",
                "ws-nowrap": ""
              }, [ _createTextVNode("\n          "), _createTextVNode(_toDisplayString(_ctx.$t('notification.request_to_follow')), 1 /* TEXT */), _createTextVNode("\n          "), _createElementVNode("time", {
                  "text-secondary": "",
                  datetime: __props.notification.createdAt
                }, "\n            ・" + _toDisplayString(_unref(timeAgo)) + "\n          ", 9 /* TEXT, PROPS */, ["datetime"]) ]) ]), _createVNode(_component_AccountCard, {
              p: "s-2 e-4 b-2",
              "hover-card": "",
              account: __props.notification.account
            }, {
              default: _withCtx(() => [
                _createVNode(_component_AccountFollowRequestButton, { account: __props.notification.account })
              ]),
              _: 1 /* STABLE */
            }) ], 64 /* STABLE_FRAGMENT */)) : (__props.notification.type === 'update') ? (_openBlock(), _createBlock(_component_StatusCard, {
            key: 4,
            ...
            meta: _withCtx(() => [
              _createElementVNode("div", {
                ...
                _createElementVNode("span", { "ws-nowrap": "" }, [
                  _createTextVNode("\n              "),
                  _createTextVNode(_toDisplayString(_ctx.$t('notification.update_status')), 1 /* TEXT */),
                  _createTextVNode("\n              "),
                  _createElementVNode("time", {
                    "text-secondary": "",
                    datetime: __props.notification.createdAt
            ...
            _: 1 /* STABLE */
          })) : ( __props.notification.type === 'mention' || __props.notification.type === 'poll' || __props.notification.type === 'status' || __props.notification.type === 'quote' ) ? (_openBlock(), _createBlock(_component_StatusCard, {
            key: 5,
            status: __props.notification.status
          })) : (__props.notification.type === 'annual_report') ? (_openBlock(), _createElementBlock("div", {
            key: 6,
            flex: "",
            p4: "",
            "items-center": "",
