...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    options: { type: Array as PropType<CommonRouteTabOption[]>, required: true },
    moreOptions: { type: null as unknown as PropType<CommonRouteTabMoreOption>, required: false },
    command: { type: Boolean as PropType<boolean>, required: false },
    replace: { type: Boolean as PropType<boolean>, required: false },
    preventScrollTop: { type: Boolean as PropType<boolean>, required: false, default: false }
  },
  setup(__props) {
