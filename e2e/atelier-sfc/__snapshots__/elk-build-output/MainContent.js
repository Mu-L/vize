...
export default /*@__PURE__*/_defineComponent({
  __name: 'MainContent',
  props: {
    back: { type: Boolean as PropType<boolean | 'small-only'>, required: false, default: false },
    backOnSmallScreen: { type: Boolean as PropType<boolean>, required: false },
    noOverflowHidden: { type: Boolean as PropType<boolean>, required: false }
  },
  setup(__props) {
      ...
      class: _normalizeClass(containerClass.value)
        ...
        class: _normalizeClass({
          ...
          border: "b base"
            ...
            "px-3": ""
          }, [ _renderSlot(_ctx.$slots, "actions"), _createVNode(_component_PwaBadge, { "xl:hidden": "" }), (_ctx.isHydrated) ? (_openBlock(), _createBlock(_component_NavUser, { key: 0 })) : (_openBlock(), _createBlock(_component_NavUserSkeleton, { key: 1 })) ]) ], 2 /* CLASS */), _renderSlot(_ctx.$slots, "header", {}, () => [ _hoisted_3 ]) ], 2 /* CLASS */), _createVNode(_component_PwaInstallPrompt, { "xl:hidden": "" }), _createElementVNode("div", {
        ...
        "m-auto": ""
          ...
          "h-6": ""
        }, null, 2 /* CLASS */), _renderSlot(_ctx.$slots, "default") ], 2 /* CLASS */) ], 2 /* CLASS */))
}
}
