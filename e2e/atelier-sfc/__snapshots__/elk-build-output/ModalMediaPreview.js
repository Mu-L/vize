      ...
      onClick: onClick
        ...
        "w-full": ""
          ...
          "overflow-hidden": ""
              ...
              "rounded-r-0": "",
              "shrink-0": ""
            }, "\n          " + _toDisplayString(_unref(index) + 1) + " / " + _toDisplayString(_ctx.mediaPreviewList.length) + "\n        ", 1 /* TEXT */)) : _createCommentVNode("v-if", true), (current.value.description) ? (_openBlock(), _createElementBlock("p", {
              key: 0,
              bg: "dark/30",
              "dark:bg": "white/10",
              p: "y-1 x-3",
