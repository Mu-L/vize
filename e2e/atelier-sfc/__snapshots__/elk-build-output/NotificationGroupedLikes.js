...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    group: { type: null as unknown as PropType<GroupedLikeNotifications>, required: true }
  },
  setup(__props) {
            ...
            (reblogs.value.length)
              ? (_openBlock(), _createElementBlock("div", {
                ...
                _createElementVNode("div", { ml1: "" }, [
                  _createTextVNode("\n            "),
                  _createTextVNode(_toDisplayString(_ctx.$t('notification.reblogged_post')), 1 /* TEXT */),
                  _createTextVNode("\n            "),
                  _createElementVNode("time", {
                    "text-secondary": "",
                    datetime: reblogsTimeAgoCreatedAt.value
                  }, "\n              ・" + _toDisplayString(_unref(reblogsTimeAgo)) + "\n            ", 9 /* TEXT, PROPS */, ["datetime"])
                ])
              ]))
            ...
            (likes.value.length)
              ? (_openBlock(), _createElementBlock("div", {
                ...
                _createElementVNode("div", { "ms-4": "" }, [
                  _createTextVNode("\n            "),
                  _createTextVNode(_toDisplayString(_ctx.$t('notification.favourited_post')), 1 /* TEXT */),
                  _createTextVNode("\n            "),
                  _createElementVNode("time", {
                    "text-secondary": "",
                    datetime: likesTimeAgoCreatedAt.value
                  }, "\n              ・" + _toDisplayString(_unref(likesTimeAgo)) + "\n            ", 9 /* TEXT, PROPS */, ["datetime"])
                ])
              ]))
              : _createCommentVNode("v-if", true)
          ]),
