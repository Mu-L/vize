...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", { class: "flex flex-col w-50vw max-w-180 h-50vh max-h-120" }, [ _createTextVNode("\n    "), _createTextVNode("\n    "), _createElementVNode("label", { class: "flex mx-3 my-1 items-center" }, [ _hoisted_1, (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(scopes.value, (scope) => {
        ...
        class: "flex-1 mx-1 overflow-y-auto"
            ...
            "text-secondary": "",
            italic: ""
          }, "\n        " + _toDisplayString(_unref(input).trim().length ? _ctx.$t('common.not_found') : _ctx.$t('search.search_desc')) + "\n      ", 1 /* TEXT */)) ], 512 /* NEED_PATCH */), _hoisted_6, _createTextVNode("\n\n    "), _createTextVNode("\n    "), _createElementVNode("div", { class: "flex items-center px-3 py-1 text-xs" }, [ _hoisted_7, _createTextVNode(" Tip: Use\n      "), _createVNode(_component_CommandKey, { name: `${modifierKeyName.value}+K` }), _createTextVNode(" to search,\n      "), _createVNode(_component_CommandKey, { name: `${modifierKeyName.value}+/` }), _createTextVNode(" to activate command mode.\n    ") ]) ]))
}
}
