...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    attachment: { type: null as unknown as PropType<mastodon.v1.MediaAttachment>, required: true },
    attachments: { type: Array as PropType<mastodon.v1.MediaAttachment[]>, required: false },
    fullSize: { type: Boolean as PropType<boolean>, required: false, default: false },
    isPreview: { type: Boolean as PropType<boolean>, required: false, default: false }
  },
  setup(__props) {

const src = computed(() => __props.attachment.previewUrl || __props.attachment.url || attachment.remoteUrl!)
const srcset = computed(() => [
  [__props.attachment.url, attachment.meta?.original?.width],
  [__props.attachment.remoteUrl, attachment.meta?.original?.width],
  [__props.attachment.previewUrl, attachment.meta?.small?.width],
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      gap: isAudio.value ? '2' : ''
          ...
          }), (!shouldLoadAttachment.value) ? (_openBlock(), _createElementBlock("span", {
              key: 0,
              class: "status-attachment-load",
              absolute: "",
              "text-sm": "",
            ...
            popper: _withCtx(() => [
              _createElementVNode("div", {
                ...
                _createElementVNode("div", {
                  ...
                  _createElementVNode("h2", _hoisted_2, "\n                " + _toDisplayString(_ctx.$t('status.img_alt.desc')) + "\n              ", 1 /* TEXT */),
                  _createElementVNode("button", {
                    ...
                    "text-secondary": "",
                    "border-base": ""
                  }, "\n                " + _toDisplayString(_ctx.$t('status.img_alt.dismiss')) + "\n              ", 1 /* TEXT */)
                ]),
                _createElementVNode("p", _hoisted_3, "\n              " + _toDisplayString(__props.attachment.description) + "\n            ", 1 /* TEXT */)
              ])
            ]),
            default: _withCtx(() => [
              _createElementVNode("button", {
              ...
              : 'rounded-1 bg-black/65 text-white hover:bg-black px1.2 py0.2')
                ...
                _createElementVNode("div", _hoisted_1, "\n            " + _toDisplayString(_ctx.$t('status.img_alt.read', [__props.attachment.type])) + "\n          ", 1 /* TEXT */),
                _createTextVNode("\n          "),
                _createTextVNode(_toDisplayString(_ctx.$t('status.img_alt.ALT')), 1 /* TEXT */),
                _createTextVNode("\n        ")
              ], 2 /* CLASS */)
            ]),
            _: 1 /* STABLE */
          })) : _createCommentVNode("v-if", true), (isGif.value && !_ctx.getPreferences(_unref(userSettings), 'hideGifIndicatorOnPosts')) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _createElementVNode("button", _hoisted_4, "\n          " + _toDisplayString(_ctx.$t('status.gif')) + "\n        ", 1 /* TEXT */) ])) : _createCommentVNode("v-if", true) ], 2 /* CLASS */) ], 8 /* PROPS */, ["gap"]))
}
}
