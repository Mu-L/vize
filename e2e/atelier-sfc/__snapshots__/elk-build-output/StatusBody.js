...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    withAction: { type: Boolean as PropType<boolean>, required: false, default: true },
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      relative: ""
        ...
        "is-nested": __props.isNested
      }), (_unref(translation).visible) ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [ _hoisted_1, (_unref(translation).success) ? (_openBlock(), _createBlock(_component_ContentRich, {
              key: 0,
              class: "line-compact",
              ...
              key: 1,
              "text-red-4": ""
            }, "\n        Error: " + _toDisplayString(_unref(translation).error) + "\n      ", 1 /* TEXT */)) ], 64 /* STABLE_FRAGMENT */)) : _createCommentVNode("v-if", true) ], 2 /* CLASS */))
}
}
