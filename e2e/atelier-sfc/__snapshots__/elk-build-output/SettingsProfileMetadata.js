...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", { "space-y-2": "" }, [ _createElementVNode("div", _hoisted_1, "\n      " + _toDisplayString(_ctx.$t('settings.profile.appearance.profile_metadata')) + "\n    ", 1 /* TEXT */), _createElementVNode("div", _hoisted_2, "\n      " + _toDisplayString(_ctx.$t('settings.profile.appearance.profile_metadata_desc', [_ctx.maxAccountFieldCount])) + "\n    ", 1 /* TEXT */), _createElementVNode("div", { flex: "~ col gap4" }, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(fieldCount.value, (i) => {
