...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    isHoverCard: { type: Boolean as PropType<boolean>, required: false }
  },
  setup(__props) {
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      "gap-5": ""
        ...
        _: 1 /* STABLE */
      }), (!(__props.isHoverCard && _ctx.getPreferences(_unref(userSettings), 'hideFollowerCount'))) ? (_openBlock(), _createBlock(_component_NuxtLink, {
          key: 0,
          ...
          _: 1 /* STABLE */
        })) : _createCommentVNode("v-if", true), (!(__props.isHoverCard && _ctx.getPreferences(_unref(userSettings), 'hideFollowerCount'))) ? (_openBlock(), _createBlock(_component_NuxtLink, {
          key: 0,
