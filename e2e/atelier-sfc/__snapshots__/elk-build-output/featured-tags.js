  ...
  return (_openBlock(), _createBlock(_component_MainContent, { back: "" }, {
      title: _withCtx(() => [
        _createVNode(_component_MainTitle, {
          ...
          default: _withCtx(() => [
            _createTextVNode("\n        "),
            _createTextVNode(_toDisplayString(_ctx.$t('settings.profile.featured_tags.label')), 1 /* TEXT */),
            _createTextVNode("\n      ")
          ]),
          _: 1 /* STABLE */
        })
      ...
      default: _withCtx(() => [
        _createElementVNode("div", {
          ...
          _createElementVNode("h1", { "text-4xl": "" }, [
            _createElementVNode("span", _hoisted_1, _toDisplayString(_ctx.$t('settings.profile.featured_tags.under_construction')), 1 /* TEXT */),
            _createTextVNode("\n        🚧\n      ")
          ]),
          _createElementVNode("h3", _hoisted_2, "\n        " + _toDisplayString(_ctx.$t('settings.profile.featured_tags.label')) + "\n      ", 1 /* TEXT */)
        ])
      ]),
      _: 1 /* STABLE */
    }))
