...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      flex: "~ col",
      "gap-6": ""
    }, [ _createElementVNode("div", _hoisted_1, "\n      " + _toDisplayString(_ctx.title) + "\n    ", 1 /* TEXT */), (_ctx.description) ? (_openBlock(), _createElementBlock("div", { key: 0 }, "\n      " + _toDisplayString(_ctx.description) + "\n    ", 1 /* TEXT */)) : _createCommentVNode("v-if", true), (isMute.value) ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          "flex-col": "",
          flex: "",
          "gap-4": ""
          ...
          }), (hasDuration.value) ? (_openBlock(), _createBlock(_component_ModalDurationPicker, {
              key: 0,
            ...
            })) : _createCommentVNode("v-if", true), _createVNode(_component_CommonCheckbox, {
          ...
          }) ])) : _createCommentVNode("v-if", true), (isBlockDomain.value) ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          "flex-col": "",
          flex: "",
          "gap-2": ""
        }, [ _createElementVNode("label", _hoisted_2, "\n        " + _toDisplayString(_ctx.$t('confirm.block_domain.type_to_confirm', [__props.domainToBlock])) + "\n      ", 1 /* TEXT */), _withDirectives(_createElementVNode("input", {
        ...
        }, "\n        " + _toDisplayString(_ctx.cancel || _ctx.$t('confirm.common.cancel')) + "\n      ", 1 /* TEXT */), _createElementVNode("button", {
          "btn-solid": "",
        ...
        }, "\n        " + _toDisplayString(_ctx.confirm || _ctx.$t('confirm.common.confirm')) + "\n      ", 9 /* TEXT, PROPS */, ["disabled"]) ]) ]))
}
}
