...
const _hoisted_1 = { block: "true", "sm:hidden": "true", "xl:block": "true", "select-none": "true", "data-v-b3952367": "" }
...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    to: { type: String as PropType<string | Record<string, string>>, required: true },
    userOnly: { type: Boolean as PropType<boolean>, required: false, default: false },
...
useCommand({
  scope: 'Navigation',
  name: () => __props.text ?? (typeof __props.to === 'string' ? to as string : __props.to.name),
  icon: () => __props.icon,
