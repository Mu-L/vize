  ...
  return (_openBlock(), _createElementBlock("footer", {
      ...
      flex: "~ col"
        ...
        mb4: ""
          ...
          _: 1 /* STABLE */
        }), _createVNode(_component_CommonTooltip, { content: _ctx.$t('nav.zen_mode') }, {
          default: _withCtx(() => [
            _createElementVNode("button", {
              flex: "",
              "text-lg": "",
          ...
          _: 1 /* STABLE */
        }), _createVNode(_component_CommonTooltip, { content: _ctx.$t('magic_keys.dialog_header') }, {
          default: _withCtx(() => [
            _createElementVNode("button", {
              flex: "",
          ...
          _: 1 /* STABLE */
        }), _createVNode(_component_CommonTooltip, { content: _ctx.$t('settings.about.sponsor_action') }, {
          default: _withCtx(() => [
          ...
          _: 1 /* STABLE */
        }) ]), _createElementVNode("div", null, [ (_ctx.isHydrated) ? (_openBlock(), _createBlock(_component_i18n_t, {
            key: 0,
            ...
            _: 1 /* STABLE */
          })) : (_openBlock(), _createElementBlock("span", { key: 1 }, _toDisplayString(_unref(buildInfo).env), 1 /* TEXT */)), (_unref(buildInfo).commit && _unref(buildInfo).branch !== 'release') ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [ _createTextVNode("\n        &middot;\n        "), _createVNode(_component_NuxtLink, {
              external: "",
              ...
              _: 1 /* STABLE */
            }) ], 64 /* STABLE_FRAGMENT */)) : _createCommentVNode("v-if", true) ]), _createElementVNode("div", null, [ _createVNode(_component_NuxtLink, {
          "cursor-pointer": "",
          "hover:underline": "",
          to: "/settings/about"
        }, {
