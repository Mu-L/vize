...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock(_Fragment, null, [ (!_unref(hideTagsTips)) ? (_openBlock(), _createBlock(_component_CommonAlert, {
          ...
          _: 1 /* STABLE */
        })) : _createCommentVNode("v-if", true), _createVNode(_component_TagCardPaginator, _normalizeProps(_guardReactiveProps({ paginator: _unref(paginator) }))) ], 64 /* STABLE_FRAGMENT */))
}
}
