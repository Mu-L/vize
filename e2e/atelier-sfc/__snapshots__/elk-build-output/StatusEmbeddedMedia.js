            ...
            relative: ""
              ...
              style: "background: linear-gradient(black, rgba(0,0,0,0.5), transparent, transparent, rgba(0,0,0,0.20))"
                ...
                default: _withCtx(() => [
                  ...
                  _createElementVNode("p", _hoisted_2, "\n            " + _toDisplayString(card.value?.title) + "\n          ", 1 /* TEXT */),
                  _createElementVNode("p", _hoisted_3, "\n            " + _toDisplayString(_ctx.$t('status.embedded_warning')) + "\n          ", 1 /* TEXT */)
                ]),
                _: 1 /* STABLE */
              }), _createElementVNode("div", {
                flex: "",
                ...
                "object-cover": "",
                "rounded-lg": ""
              })) : _createCommentVNode("v-if", true) ])) : (_openBlock(), _createElementBlock("div", { key: 1 }, [ _createTextVNode("\n      "), _createTextVNode("\n      "), (vnode.value) ? (_openBlock(), _createBlock(_resolveDynamicComponent(vnode.value), {
                key: 0,
                is: vnode.value,
                "rounded-lg": "",
                "h-80": ""
