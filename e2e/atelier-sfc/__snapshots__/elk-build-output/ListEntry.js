  ...
  return (_openBlock(), _createElementBlock(_Fragment, null, [ _createElementVNode("form", {
        ...
        onSubmit: _cache[0] || (_cache[0] = _withModifiers((...args) => (submit && submit(...args)), ["prevent"]))
            ...
            "gap-3": ""
                ...
                _: 1 /* STABLE */
              })) : _createCommentVNode("v-if", true), _withDirectives(_createElementVNode("input", {
              ref: input,
          ...
          gap2: ""
              ...
              _: 1 /* STABLE */
            })), _createVNode(_component_CommonTooltip, { content: _ctx.$t('list.delete') }, {
            default: _withCtx(() => [
              _createElementVNode("button", {
                type: "button",
                "text-sm": "",
            ...
            _: 1 /* STABLE */
          }) ]) ], 42 /* CLASS, PROPS, NEED_HYDRATION */, ["aria-describedby"]), (actionError.value) ? (_openBlock(), _createBlock(_component_CommonErrorMessage, {
          key: 0,
