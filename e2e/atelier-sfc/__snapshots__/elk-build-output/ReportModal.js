...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    status: { type: null as unknown as PropType<mastodon.v1.Status>, required: false }
  },
  emits: ["close"],
...
function unfollow() {
  emit('close')
  toggleFollowAccount(useRelationship(account).value!, __props.account)
}
function mute() {
  emit('close')
  toggleMuteAccount(useRelationship(account).value!, __props.account)
}
function block() {
  emit('close')
  toggleBlockAccount(useRelationship(account).value!, __props.account)
}
function resetModal() {
...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      relative: ""
        ...
        onClick: _cache[0] || (_cache[0] = ($event: any) => (emit('close')))
      }, [ _hoisted_2 ], 8 /* PROPS */, ["aria-label"]), (step.value === 'selectCategory') ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [ _createElementVNode("h1", _hoisted_3, "\n        " + _toDisplayString(__props.status ? _ctx.$t('report.whats_wrong_post') : _ctx.$t('report.whats_wrong_account')) + "\n      ", 1 /* TEXT */), _createElementVNode("p", _hoisted_4, "\n        " + _toDisplayString(_ctx.$t('report.select_one')) + "\n      ", 1 /* TEXT */), _createElementVNode("div", null, [ _withDirectives(_createElementVNode("input", {
              id: "dontlike",
              "onUpdate:modelValue": [($event: any) => ((reportReason).value = $event), ($event: any) => ((reportReason).value = $event)],
              type: "radio",
              value: "dontlike"
            }, null, 512 /* NEED_PATCH */), [ [_vModelRadio, reportReason.value] ]), _createElementVNode("label", _hoisted_5, _toDisplayString(_ctx.$t('report.dontlike')), 1 /* TEXT */), _createElementVNode("p", _hoisted_6, "\n          " + _toDisplayString(_ctx.$t('report.dontlike_desc')) + "\n        ", 1 /* TEXT */) ]), _createElementVNode("div", null, [ _withDirectives(_createElementVNode("input", {
              id: "spam",
              "onUpdate:modelValue": [($event: any) => ((reportReason).value = $event), ($event: any) => ((reportReason).value = $event)],
              type: "radio",
              value: "spam"
            }, null, 512 /* NEED_PATCH */), [ [_vModelRadio, reportReason.value] ]), _createElementVNode("label", _hoisted_7, _toDisplayString(_ctx.$t('report.spam')), 1 /* TEXT */), _createElementVNode("p", _hoisted_8, "\n          " + _toDisplayString(_ctx.$t('report.spam_desc')) + "\n        ", 1 /* TEXT */) ]), (serverRules.value.length > 0) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _withDirectives(_createElementVNode("input", {
                id: "violation",
                "onUpdate:modelValue": [($event: any) => ((reportReason).value = $event), ($event: any) => ((reportReason).value = $event)],
                type: "radio",
                value: "violation"
                  ...
                  "text-primary": "",
                  "font-bold": ""
                }, "\n          " + _toDisplayString(_ctx.$t('report.select_many')) + "\n        ", 1 /* TEXT */)) : _createCommentVNode("v-if", true), _createElementVNode("ul", { "pl-6": "" }, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(serverRules.value, (rule) => {
              ...
              type: "radio",
              value: "other"
            }, null, 512 /* NEED_PATCH */), [ [_vModelRadio, reportReason.value] ]), _createElementVNode("label", _hoisted_10, _toDisplayString(_ctx.$t('report.other')), 1 /* TEXT */), _createElementVNode("p", _hoisted_11, "\n          " + _toDisplayString(_ctx.$t('report.other_desc')) + "\n        ", 1 /* TEXT */) ]), (reportReason.value && reportReason.value !== 'dontlike') ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _createElementVNode("h3", _hoisted_12, "\n          " + _toDisplayString(_ctx.$t('report.anything_else')) + "\n        ", 1 /* TEXT */), _withDirectives(_createElementVNode("textarea", {
              ...
              }, null, 8 /* PROPS */, ["placeholder"]), [ [_vModelText, additionalComments.value] ]), (_ctx.getServerName(__props.account) && _ctx.getServerName(__props.account) !== _ctx.currentServer) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _createElementVNode("h3", _hoisted_13, "\n            " + _toDisplayString(_ctx.$t('report.another_server')) + "\n          ", 1 /* TEXT */), _createElementVNode("p", _hoisted_14, "\n            " + _toDisplayString(_ctx.$t('report.forward_question')) + "\n          ", 1 /* TEXT */), _withDirectives(_createElementVNode("input", {
                    id: "forward",
            ...
            onClick: _cache[1] || (_cache[1] = ($event: any) => (categoryChosen()))
          }, "\n        " + _toDisplayString(_ctx.$t('action.next')) + "\n      ", 9 /* TEXT, PROPS */, ["disabled"]) ], 64 /* STABLE_FRAGMENT */)) : (step.value === 'selectStatuses') ? (_openBlock(), _createElementBlock(_Fragment, { key: 1 }, [ _createElementVNode("h1", _hoisted_15, "\n        " + _toDisplayString(__props.status ? _ctx.$t('report.select_posts_other') : _ctx.$t('report.select_posts')) + "\n      ", 1 /* TEXT */), _createElementVNode("p", _hoisted_16, "\n        " + _toDisplayString(_ctx.$t('report.select_many')) + "\n      ", 1 /* TEXT */), _createElementVNode("table", null, [ (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(availableStatuses.value, (availableStatus) => {
              ...
              onClick: _cache[2] || (_cache[2] = ($event: any) => (submitReport()))
            }, "\n        " + _toDisplayString(_ctx.$t('report.submit')) + "\n      ", 1 /* TEXT */) ], 64 /* STABLE_FRAGMENT */)) : (step.value === 'furtherActions') ? (_openBlock(), _createElementBlock(_Fragment, { key: 2 }, [ _createElementVNode("h1", _hoisted_17, "\n        " + _toDisplayString(reportReason.value === 'dontlike' ? _ctx.$t('report.further_actions.limit.title') : _ctx.$t('report.further_actions.report.title')) + "\n      ", 1 /* TEXT */), _createElementVNode("p", _hoisted_18, "\n        " + _toDisplayString(reportReason.value === 'dontlike' ? _ctx.$t('report.further_actions.limit.description') : _ctx.$t('report.further_actions.report.description')) + "\n      ", 1 /* TEXT */), (_unref(useRelationship)(__props.account).value?.following) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _createElementVNode("button", {
                  "btn-outline": "",
                  mxa: "",
                  "mt-4": "",
                  "mb-2": "",
                  onClick: _cache[3] || (_cache[3] = ($event: any) => (unfollow()))
                    ...
                    _: 1 /* STABLE */
                  }) ]), _hoisted_19, _createTextVNode("\n        "), _toDisplayString(_ctx.$t('report.unfollow_desc')), _createTextVNode("\n      ") ])) : _createCommentVNode("v-if", true), (!_unref(useRelationship)(__props.account).value?.muting) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _createElementVNode("button", {
                  "btn-outline": "",
                  mxa: "",
                  "mt-4": "",
                  "mb-2": "",
                  onClick: _cache[4] || (_cache[4] = ($event: any) => (mute()))
                    ...
                    _: 1 /* STABLE */
                  }) ]), _hoisted_20, _createTextVNode("\n        "), _toDisplayString(_ctx.$t('report.mute_desc')), _createTextVNode("\n      ") ])) : _createCommentVNode("v-if", true), (!_unref(useRelationship)(__props.account).value?.blocking) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [ _createElementVNode("button", {
                  "btn-outline": "",
                  mxa: "",
                  "mt-4": "",
                  "mb-2": "",
                  onClick: _cache[5] || (_cache[5] = ($event: any) => (block()))
                    ...
                    _: 1 /* STABLE */
                  }) ]), _hoisted_21, _createTextVNode("\n        "), _toDisplayString(_ctx.$t('report.block_desc')), _createTextVNode("\n      ") ])) : _createCommentVNode("v-if", true), _createElementVNode("button", {
              "btn-solid": "",
              mxa: "",
              "mt-10": "",
              onClick: _cache[6] || (_cache[6] = ($event: any) => (emit('close')))
            }, "\n        " + _toDisplayString(_ctx.$t('action.done')) + "\n      ", 1 /* TEXT */) ], 64 /* STABLE_FRAGMENT */)) : _createCommentVNode("v-if", true) ]))
}
}
