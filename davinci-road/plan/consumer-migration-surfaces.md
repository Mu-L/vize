...
| -------------------------- | ------------: | --------------------: | ----------------: | --------------: | ------: | --------------: | -------: | ------------: | ------------: |
| Compiler                   |          1186 |                   823 |               363 |             163 |     386 |            1047 |      688 |           592 |           744 |
| Linter                     |           375 |                   375 |                 0 |             299 |     303 |             731 |      246 |           390 |           573 |
| Typechecker                |           981 |                   270 |               711 |             449 |     226 |             927 |      729 |           537 |           774 |
...
Additional source/manifest rows are in the TSV: 346 omitted.
...
Additional test/dev rows are in the TSV: 275 omitted.
...
| `crates/vize_canon/Cargo.toml:24`                                              | manifest | S0 1<br>old AST/parser 3<br>Croquis analysis 1<br>raw OXC 6 |    11 |
...
Additional source/manifest rows are in the TSV: 357 omitted.
...
Additional test/dev rows are in the TSV: 210 omitted.
...
Additional source/manifest rows are in the TSV: 128 omitted.
