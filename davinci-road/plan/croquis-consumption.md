...
| -------------------------------------- | ----- | ------------------- | ------------------- | ----: | ----: |
| `Analyzer`                             | type  | `analyzer`          | `vize_canon`        |    35 |   142 |
...
| `AnalyzerOptions`                      | type  | `analyzer`          | `vize_canon`        |    35 |   138 |
...
| `ScopeData`                            | type  | `scope`             | `vize_canon`        |    11 |    16 |
...
| `Croquis.scopes`                       | field | `croquis`           | `vize_canon`        |    17 |    40 |
...
| -------------------------------------- | -------: | ---: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Analyzer`                             |      185 |  274 | `vize_canon` (142/219), `vize_croquis_cf` (40/49), `vize_doctor` (0/1), `vize_maestro` (2/3), `vize_vitrine` (1/2)                                                                                                                                                                                                                                                                                  |
| `AnalyzerOptions`                      |      160 |  275 | `vize_canon` (138/215), `vize_croquis_cf` (19/56), `vize_maestro` (2/3)                                                                                                                                                                                                                                                                                                                             |
...
| `Croquis`                              |      337 |  535 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (9/21), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (165/239), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/18), `vize_patina` (20/45), `vize_vitrine` (1/4)                                                                            |
...
| `Scope`                                |       17 |   84 | `vize` (0/1), `vize_atelier_core` (0/3), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (0/1), `vize_atelier_sfc` (0/5), `vize_atelier_ssr` (0/3), `vize_canon` (17/48), `vize_davinci` (0/1), `vize_maestro` (0/7), `vize_patina` (0/6), `vize_relief` (0/2), `vize_s1_to_s2` (0/3), `vize_s2` (0/1), `vize_vitrine` (0/2)                                                                           |
| `ScopeBinding`                         |        1 |   23 | `vize_atelier_core` (1/2), `vize_s1_to_s2` (0/12), `vize_s2` (0/9)                                                                                                                                                                                                                                                                                                                                  |
| `ScopeChain`                           |        9 |   12 | `vize_atelier_core` (2/3), `vize_canon` (7/9)                                                                                                                                                                                                                                                                                                                                                       |
| `ScopeData`                            |       26 |   39 | `vize_canon` (16/27), `vize_patina` (2/4)                                                                                                                                                                                                                                                                                                                                                           |
| `ScopeId`                              |       37 |   56 | `vize_canon` (13/18), `vize_croquis_cf` (23/33), `vize_maestro` (1/2), `vize_patina` (0/1), `vize_vitrine` (0/2)                                                                                                                                                                                                                                                                                    |
...
| `Span`                                 |        0 |  586 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/63), `vize_atelier_sfc` (0/6), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/89), `vize_davinci` (0/20), `vize_maestro` (0/4), `vize_patina` (0/145), `vize_relief` (0/8), `vize_s1_to_s2` (0/77), `vize_s2` (0/115)                                                                                                           |
| `SpreadProp`                           |        5 |    9 | `vize_canon` (5/9)                                                                                                                                                                                                                                                                                                                                                                                  |
| `Symbol`                               |        0 |   69 | `vize_atelier_core` (0/5), `vize_atelier_sfc` (0/4), `vize_atelier_ssr` (0/2), `vize_canon` (0/3), `vize_croquis_cf` (0/27), `vize_fresco` (0/2), `vize_maestro` (0/1), `vize_patina` (0/15), `vize_relief` (0/5), `vize_s1_to_s2` (0/2), `vize_vitrine` (0/3)                                                                                                                                      |
...
| `Croquis.bindings`                     |       76 |  591 | `vize` (0/2), `vize_atelier_core` (2/24), `vize_atelier_sfc` (16/224), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (43/88), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/169), `vize_s2` (0/21), `vize_vitrine` (2/7) |
| `Croquis.component_usages`             |       52 |   57 | `vize_croquis_cf` (33/38)                                                                                                                                                                                                                                                                                                                                                                           |
| `Croquis.hoists`                       |        0 |   16 | `vize_atelier_core` (0/8), `vize_atelier_sfc` (0/2), `vize_relief` (0/1), `vize_s1_to_s2` (0/5)                                                                                                                                                                                                                                                                                                     |
| `Croquis.import_statements`            |        9 |   11 | `vize_maestro` (0/1), `vize_musea` (0/1)                                                                                                                                                                                                                                                                                                                                                            |
| `Croquis.macros`                       |      132 |  252 | `vize_atelier_sfc` (11/102), `vize_canon` (58/60), `vize_croquis_cf` (25/27), `vize_davinci` (0/4), `vize_maestro` (13/23), `vize_musea` (0/2), `vize_patina` (22/31)                                                                                                                                                                                                                               |
...
| `Croquis.scopes`                       |       78 |  123 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/6), `vize_canon` (40/42), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_patina` (2/15), `vize_s1_to_s2` (0/9)                                                                                                                                                                                                                    |
