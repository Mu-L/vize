...
| `Analyzer`                             | type  | `analyzer`          | `vize_canon`        |    42 |   160 |
...
| `AnalyzerOptions`                      | type  | `analyzer`          | `vize_canon`        |    42 |   156 |
...
| `ComponentUsage`                       | type  | `croquis::template` | `vize_canon`        |    20 |    44 |
...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    89 |   211 |
| `Croquis`                              | type  | `croquis`           | `vize_croquis_cf`   |    40 |   101 |
| `Croquis`                              | type  | `croquis`           | `vize_maestro`      |     5 |     7 |
| `Croquis`                              | type  | `croquis`           | `vize_patina`       |     8 |    22 |
| `Croquis`                              | type  | `croquis`           | `vize_vitrine`      |     2 |     2 |
...
| `EventHandlerScopeData`                | type  | `scope`             | `vize_canon`        |     7 |     9 |
| `EventHandlerScopeData`                | type  | `scope`             | `vize_croquis_cf`   |     1 |     1 |
| `EventListener`                        | type  | `croquis::template` | `vize_canon`        |     2 |     3 |
...
| `PassedProp`                           | type  | `croquis::template` | `vize_canon`        |    10 |    23 |
...
| `ScopeKind`                            | type  | `scope`             | `vize_canon`        |    17 |    59 |
| `ScopeKind`                            | type  | `scope`             | `vize_croquis_cf`   |    10 |    21 |
| `ScopeKind`                            | type  | `scope`             | `vize_maestro`      |     9 |    65 |
| `ScopeKind`                            | type  | `scope`             | `vize_patina`       |     2 |     3 |
| `ScopeKind`                            | type  | `scope`             | `vize_vitrine`      |     1 |     6 |
...
| `SpreadProp`                           | type  | `croquis::template` | `vize_canon`        |     4 |     6 |
| `TemplateExpression`                   | type  | `croquis`           | `vize_canon`        |    11 |    22 |
| `TemplateExpression`                   | type  | `croquis`           | `vize_croquis_cf`   |     2 |     3 |
| `TemplateExpressionKind`               | type  | `croquis`           | `vize_canon`        |     6 |    14 |
...
| `Croquis.binding_spans`                | field | `croquis`           | `vize_canon`        |     6 |     9 |
...
| `Croquis.bindings`                     | field | `croquis`           | `vize_canon`        |    26 |    45 |
| `Croquis.bindings`                     | field | `croquis`           | `vize_croquis_cf`   |     2 |     2 |
| `Croquis.bindings`                     | field | `croquis`           | `vize_maestro`      |     5 |     8 |
...
| `Croquis.component_usages`             | field | `croquis`           | `vize_canon`        |    16 |    20 |
...
| `Croquis.macros`                       | field | `croquis`           | `vize_canon`        |    29 |    75 |
...
| `Croquis.pattern_diagnostics`          | field | `croquis`           | `vize_canon`        |     2 |     4 |
| `Croquis.pattern_diagnostics`          | field | `croquis`           | `vize_maestro`      |     2 |     3 |
| `Croquis.pattern_diagnostics`          | field | `croquis`           | `vize_vitrine`      |     2 |     3 |
...
| `Croquis.reactivity`                   | field | `croquis`           | `vize_canon`        |     2 |     3 |
...
| `Croquis.scopes`                       | field | `croquis`           | `vize_atelier_sfc`  |     1 |     2 |
| `Croquis.scopes`                       | field | `croquis`           | `vize_canon`        |    31 |    59 |
| `Croquis.scopes`                       | field | `croquis`           | `vize_croquis_cf`   |    17 |    27 |
| `Croquis.scopes`                       | field | `croquis`           | `vize_maestro`      |     8 |    15 |
...
| `ModelDefinition`                            | `vize_canon`        |     5 |     8 |
...
| `SfcDescriptor`                              | `vize_canon`        |    10 |    25 |
...
| `SfcError`                                   | `vize_musea`        |     1 |     1 |
| `SfcError`                                   | `vize_patina`       |     1 |     2 |
| `SfcParseOptions`                            | `vize`              |    10 |    13 |
...
| `SfcParseOptions`                            | `vize_musea`        |     1 |     1 |
...
| `extract_identifiers_oxc`                    | `vize_canon`        |     5 |     6 |
...
| `is_dynamic_component_alias`                 | `vize_canon`        |     3 |     4 |
...
| `is_runtime_builtin_component`               | `vize_canon`        |     1 |     1 |
...
| -------------------------------------- | -------: | ---: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Analyzer`                             |      204 |  299 | `vize` (1/2), `vize_canon` (160/242), `vize_croquis_cf` (40/49), `vize_doctor` (0/1), `vize_maestro` (2/3), `vize_vitrine` (1/2)                                                                                                                                                                                                                                                                                                                                                                                            |
| `AnalyzerOptions`                      |      179 |  300 | `vize` (1/2), `vize_canon` (156/238), `vize_croquis_cf` (19/56), `vize_maestro` (2/3)                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `BindingMetadata`                      |       37 |  136 | `vize_atelier_core` (0/24), `vize_atelier_dom` (0/20), `vize_atelier_jsx` (1/2), `vize_atelier_sfc` (31/49), `vize_atelier_ssr` (0/6), `vize_atelier_vapor` (0/15), `vize_canon` (5/7), `vize_relief` (0/6), `vize_s1_to_s2` (0/1), `vize_vitrine` (0/6)                                                                                                                                                                                                                                                                    |
| `COMPILER_MACRO_NAMES`                 |        1 |    3 | `vize_canon` (0/1), `vize_patina` (1/2)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `ComponentShape`                       |        1 |    2 | `vize_maestro` (1/2)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `ComponentUsage`                       |       87 |  157 | `vize_canon` (44/64), `vize_croquis_cf` (38/85), `vize_maestro` (5/8)                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `Croquis`                              |      405 |  644 | `vize` (1/2), `vize_atelier_core` (17/25), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/5), `vize_canon` (211/314), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (7/23), `vize_patina` (22/47), `vize_s1_to_s2` (0/1), `vize_vitrine` (2/5)                                                                                                                                                                            |
...
| `EffectGraph`                          |        0 |    1 | `vize_davinci` (0/1)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `EventHandlerScopeData`                |       10 |   18 | `vize_canon` (9/16), `vize_croquis_cf` (1/2)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `EventListener`                        |       15 |   25 | `vize_canon` (3/5), `vize_croquis_cf` (10/16), `vize_maestro` (2/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| `PassedProp`                           |       44 |   66 | `vize_canon` (23/34), `vize_croquis_cf` (17/25), `vize_maestro` (4/7)                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `Scope`                                |       27 |  105 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (0/1), `vize_atelier_sfc` (0/5), `vize_atelier_ssr` (0/3), `vize_canon` (25/58), `vize_davinci` (0/1), `vize_maestro` (0/3), `vize_musea` (0/1), `vize_patina` (2/19), `vize_relief` (0/3), `vize_s1_to_s2` (0/2), `vize_s2` (0/1), `vize_vitrine` (0/2)                                                                                                                                                                              |
...
| `ScopeData`                            |       53 |   76 | `vize_canon` (35/53), `vize_maestro` (8/11), `vize_patina` (2/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `ScopeId`                              |       46 |   67 | `vize_canon` (22/29), `vize_croquis_cf` (23/33), `vize_maestro` (1/2), `vize_patina` (0/1), `vize_vitrine` (0/2)                                                                                                                                                                                                                                                                                                                                                                                                            |
| `ScopeKind`                            |      158 |  191 | `vize_atelier_core` (2/3), `vize_atelier_sfc` (2/3), `vize_canon` (59/76), `vize_croquis_cf` (21/25), `vize_maestro` (65/73), `vize_patina` (3/5)                                                                                                                                                                                                                                                                                                                                                                           |
| `SlotUsage`                            |        7 |   17 | `vize_canon` (1/3), `vize_croquis_cf` (3/8), `vize_maestro` (3/6)                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `Span`                                 |        0 |  826 | `vize_armature` (0/24), `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/75), `vize_atelier_sfc` (0/6), `vize_atelier_ssr` (0/10), `vize_atelier_vapor` (0/1), `vize_canon` (0/63), `vize_carton` (0/89), `vize_davinci` (0/35), `vize_extension_host` (0/20), `vize_impeto` (0/42), `vize_maestro` (0/9), `vize_patina` (0/171), `vize_relief` (0/8), `vize_s1_to_s2` (0/133), `vize_s2` (0/117), `vize_s2_to_s3` (0/21)                                                                                                   |
| `SpreadProp`                           |        6 |   10 | `vize_canon` (6/10)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `Symbol`                               |        0 |   69 | `vize_atelier_core` (0/5), `vize_atelier_sfc` (0/4), `vize_atelier_ssr` (0/2), `vize_canon` (0/4), `vize_croquis_cf` (0/27), `vize_fresco` (0/2), `vize_maestro` (0/1), `vize_patina` (0/15), `vize_relief` (0/5), `vize_s1_to_s2` (0/1), `vize_vitrine` (0/3)                                                                                                                                                                                                                                                              |
| `SymbolFlags`                          |        0 |    5 | `vize_atelier_sfc` (0/5)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `SymbolId`                             |        0 |   12 | `vize_canon` (0/3), `vize_davinci` (0/1), `vize_maestro` (0/5), `vize_patina` (0/3)                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `TemplateExpression`                   |       25 |   51 | `vize_canon` (22/32), `vize_croquis_cf` (3/5), `vize_maestro` (0/14)                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `TemplateExpressionKind`               |       23 |   34 | `vize_canon` (14/20), `vize_croquis_cf` (9/14)                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `Croquis.binding_spans`                |       13 |   14 | `vize_maestro` (2/3)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `Croquis.bindings`                     |       77 |  733 | `vize` (0/2), `vize_armature` (0/9), `vize_atelier_core` (2/35), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (1/36), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/9), `vize_atelier_vapor` (0/8), `vize_canon` (45/89), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_impeto` (0/3), `vize_maestro` (8/14), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/236), `vize_s2` (0/21), `vize_s2_to_s3` (0/3), `vize_vitrine` (2/7) |
| `Croquis.component_usages`             |       61 |   66 | `vize_croquis_cf` (33/38)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `Croquis.macros`                       |      150 |  268 | `vize_atelier_sfc` (11/102), `vize_canon` (75/76), `vize_croquis_cf` (25/27), `vize_davinci` (0/4), `vize_maestro` (14/24), `vize_musea` (0/1), `vize_patina` (22/31)                                                                                                                                                                                                                                                                                                                                                       |
| `Croquis.pattern_diagnostics`          |       10 |   11 | `vize_maestro` (3/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `Croquis.provide_inject`               |       28 |   36 | `vize_croquis_cf` (26/34)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `Croquis.race_conditions`              |        1 |    4 | `vize_croquis_cf` (1/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `Croquis.reactivity`                   |       33 |   40 | `vize_atelier_core` (0/1), `vize_davinci` (0/3), `vize_patina` (1/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `Croquis.scopes`                       |      109 |  169 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/11), `vize_canon` (59/61), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_maestro` (15/16), `vize_patina` (4/25), `vize_s1_to_s2` (0/10)                                                                                                                                                                                                                                                                                                                  |
| `Croquis.setup_context`                |        2 |    5 | `vize_croquis_cf` (1/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `Croquis.template_info`                |       18 |   20 | `vize_croquis_cf` (14/15), `vize_patina` (0/1)                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `Croquis.types`                        |        9 |   44 | `vize` (0/1), `vize_atelier_sfc` (0/13), `vize_canon` (9/17), `vize_davinci` (0/3), `vize_maestro` (0/1), `vize_marquette` (0/8), `vize_patina` (0/1)                                                                                                                                                                                                                                                                                                                                                                       |
| `Croquis.undefined_refs`               |        8 |    9 | `vize_canon` (7/8)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
