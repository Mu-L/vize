...
| `Croquis`                              |      338 |  536 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (9/21), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (166/240), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/18), `vize_patina` (20/45), `vize_vitrine` (1/4)                                                                            |
...
| `Span`                                 |        0 |  575 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/63), `vize_atelier_sfc` (0/6), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/89), `vize_davinci` (0/20), `vize_maestro` (0/4), `vize_patina` (0/145), `vize_relief` (0/8), `vize_s1_to_s2` (0/66), `vize_s2` (0/115)                                                                                                           |
...
| `Croquis.bindings`                     |       76 |  563 | `vize` (0/2), `vize_atelier_core` (2/24), `vize_atelier_sfc` (16/224), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (43/88), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/141), `vize_s2` (0/21), `vize_vitrine` (2/7) |
| `Croquis.component_usages`             |       52 |   57 | `vize_croquis_cf` (33/38)                                                                                                                                                                                                                                                                                                                                                                           |
| `Croquis.hoists`                       |        0 |   15 | `vize_atelier_core` (0/8), `vize_atelier_sfc` (0/2), `vize_relief` (0/1), `vize_s1_to_s2` (0/4)                                                                                                                                                                                                                                                                                                     |
...
| `Croquis.scopes`                       |       79 |  124 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/6), `vize_canon` (41/43), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_patina` (2/15), `vize_s1_to_s2` (0/9)                                                                                                                                                                                                                    |
