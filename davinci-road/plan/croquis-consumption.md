...
| -------------------------------------- | ----- | ------------------- | ------------------- | ----: | ----: |
| `Analyzer`                             | type  | `analyzer`          | `vize_canon`        |    33 |   137 |
...
| `AnalyzerOptions`                      | type  | `analyzer`          | `vize_canon`        |    33 |   133 |
...
| `ComponentUsage`                       | type  | `croquis::template` | `vize_canon`        |    13 |    31 |
...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    66 |   163 |
...
| `Croquis.macros`                       | field | `croquis`           | `vize_canon`        |    17 |    57 |
...
| -------------------------------------- | -------: | ---: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Analyzer`                             |      179 |  265 | `vize_canon` (137/212), `vize_croquis_cf` (40/49), `vize_doctor` (0/1), `vize_vitrine` (1/2)                                                                                                                                                                                                                                                             |
| `AnalyzerOptions`                      |      154 |  266 | `vize_canon` (133/208), `vize_croquis_cf` (19/56)                                                                                                                                                                                                                                                                                                        |
...
| `ComponentUsage`                       |       74 |  137 | `vize_canon` (31/44), `vize_croquis_cf` (38/85), `vize_maestro` (5/8)                                                                                                                                                                                                                                                                                    |
| `Croquis`                              |      334 |  529 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (9/21), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (163/236), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/17), `vize_patina` (19/43), `vize_vitrine` (1/4)                                 |
...
| `Scope`                                |       17 |   80 | `vize` (0/1), `vize_atelier_core` (0/3), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (0/1), `vize_atelier_sfc` (0/5), `vize_atelier_ssr` (0/3), `vize_canon` (17/48), `vize_davinci` (0/1), `vize_maestro` (0/7), `vize_patina` (0/6), `vize_relief` (0/2), `vize_vitrine` (0/2)                                                                        |
| `ScopeBinding`                         |        1 |    2 | `vize_atelier_core` (1/2)                                                                                                                                                                                                                                                                                                                                |
| `ScopeChain`                           |        9 |   12 | `vize_atelier_core` (2/3), `vize_canon` (7/9)                                                                                                                                                                                                                                                                                                            |
| `ScopeData`                            |       27 |   41 | `vize_canon` (17/29), `vize_patina` (2/4)                                                                                                                                                                                                                                                                                                                |
...
| `Croquis.bindings`                     |       75 |  403 | `vize` (0/2), `vize_atelier_core` (2/26), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (43/88), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_maestro` (8/12), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_vitrine` (2/7) |
...
| `Croquis.macros`                       |      128 |  246 | `vize_atelier_sfc` (11/102), `vize_canon` (57/59), `vize_croquis_cf` (25/27), `vize_davinci` (0/4), `vize_maestro` (12/20), `vize_musea` (0/2), `vize_patina` (20/29)                                                                                                                                                                                    |
