...
| `Scope`                                |       17 |   81 | `vize` (0/1), `vize_atelier_core` (0/3), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (0/1), `vize_atelier_sfc` (0/5), `vize_atelier_ssr` (0/3), `vize_canon` (17/48), `vize_davinci` (0/1), `vize_disegno` (0/1), `vize_maestro` (0/7), `vize_patina` (0/6), `vize_relief` (0/2), `vize_vitrine` (0/2)                                                                                               |
| `ScopeBinding`                         |        1 |   15 | `vize_atelier_core` (1/2), `vize_disegno` (0/9), `vize_ricalco` (0/4)                                                                                                                                                                                                                                                                                                                                 |
...
| `Croquis.bindings`                     |       76 |  419 | `vize` (0/2), `vize_atelier_core` (2/24), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (43/88), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_disegno` (0/15), `vize_fresco` (0/6), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_ricalco` (0/2), `vize_vitrine` (2/7) |
