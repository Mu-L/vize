...
| -------------------------------------- | ----- | ------------------- | ------------------- | ----: | ----: |
| `Analyzer`                             | type  | `analyzer`          | `vize_canon`        |    34 |   140 |
...
| `AnalyzerOptions`                      | type  | `analyzer`          | `vize_canon`        |    34 |   136 |
...
| `ComponentUsage`                       | type  | `croquis::template` | `vize_canon`        |    13 |    33 |
...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    67 |   166 |
...
| `Drawer`                               | type  | `drawer`            | `vize_maestro`      |    17 |    21 |
| `Drawer`                               | type  | `drawer`            | `vize_patina`       |     1 |     1 |
| `DrawerOptions`                        | type  | `drawer`            | `vize_atelier_sfc`  |     1 |     5 |
| `DrawerOptions`                        | type  | `drawer`            | `vize_maestro`      |    17 |    21 |
...
| `ScopeKind`                            | type  | `scope`             | `vize_maestro`      |     6 |    42 |
...
| `Croquis.scopes`                       | field | `croquis`           | `vize_maestro`      |     5 |     6 |
...
| -------------------------------------- | -------: | ---: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `Analyzer`                             |      182 |  269 | `vize_canon` (140/216), `vize_croquis_cf` (40/49), `vize_doctor` (0/1), `vize_vitrine` (1/2)                                                                                                                                                                                                                                                                                                           |
| `AnalyzerOptions`                      |      157 |  270 | `vize_canon` (136/212), `vize_croquis_cf` (19/56)                                                                                                                                                                                                                                                                                                                                                      |
...
| `ComponentUsage`                       |       76 |  139 | `vize_canon` (33/46), `vize_croquis_cf` (38/85), `vize_maestro` (5/8)                                                                                                                                                                                                                                                                                                                                  |
| `Croquis`                              |      337 |  534 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (9/21), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (166/240), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/18), `vize_patina` (19/43), `vize_vitrine` (1/4)                                                                               |
| `CroquisSemanticSnapshot`              |        3 |    4 | `vize_curator` (3/4)                                                                                                                                                                                                                                                                                                                                                                                   |
| `CroquisSemanticSummary`               |        1 |    2 | `vize_curator` (1/2)                                                                                                                                                                                                                                                                                                                                                                                   |
| `Drawer`                               |       30 |   50 | `vize_atelier_jsx` (1/2), `vize_atelier_sfc` (7/9), `vize_canon` (0/1), `vize_maestro` (21/36), `vize_patina` (1/2)                                                                                                                                                                                                                                                                                    |
| `DrawerOptions`                        |       26 |   43 | `vize_atelier_sfc` (5/6), `vize_maestro` (21/37)                                                                                                                                                                                                                                                                                                                                                       |
...
| `Scope`                                |       17 |   82 | `vize` (0/1), `vize_atelier_core` (0/3), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (0/1), `vize_atelier_sfc` (0/5), `vize_atelier_ssr` (0/3), `vize_canon` (17/48), `vize_davinci` (0/1), `vize_disegno` (0/1), `vize_maestro` (0/7), `vize_patina` (0/6), `vize_relief` (0/2), `vize_ricalco` (0/1), `vize_vitrine` (0/2)                                                                          |
| `ScopeBinding`                         |        1 |   21 | `vize_atelier_core` (1/2), `vize_disegno` (0/9), `vize_ricalco` (0/10)                                                                                                                                                                                                                                                                                                                                 |
...
| `ScopeKind`                            |      104 |  125 | `vize_atelier_core` (1/2), `vize_canon` (36/47), `vize_croquis_cf` (21/25), `vize_maestro` (42/47)                                                                                                                                                                                                                                                                                                     |
| `SlotUsage`                            |        5 |   13 | `vize_canon` (0/1), `vize_croquis_cf` (3/8), `vize_maestro` (2/4)                                                                                                                                                                                                                                                                                                                                      |
| `Span`                                 |        0 |  506 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/63), `vize_atelier_sfc` (0/6), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/71), `vize_davinci` (0/20), `vize_disegno` (0/86), `vize_maestro` (0/4), `vize_patina` (0/143), `vize_relief` (0/8), `vize_ricalco` (0/46)                                                                                                           |
| `SpreadProp`                           |        5 |    9 | `vize_canon` (5/9)                                                                                                                                                                                                                                                                                                                                                                                     |
| `Symbol`                               |        0 |   67 | `vize_atelier_core` (0/5), `vize_atelier_sfc` (0/4), `vize_atelier_ssr` (0/2), `vize_canon` (0/3), `vize_croquis_cf` (0/27), `vize_fresco` (0/2), `vize_maestro` (0/1), `vize_patina` (0/15), `vize_relief` (0/5), `vize_vitrine` (0/3)                                                                                                                                                                |
...
| `Croquis.bindings`                     |       76 |  454 | `vize` (0/2), `vize_atelier_core` (2/24), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (43/88), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_disegno` (0/20), `vize_fresco` (0/6), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_ricalco` (0/32), `vize_vitrine` (2/7) |
...
| `Croquis.macros`                       |      130 |  248 | `vize_atelier_sfc` (11/102), `vize_canon` (58/60), `vize_croquis_cf` (25/27), `vize_davinci` (0/4), `vize_maestro` (12/20), `vize_musea` (0/2), `vize_patina` (21/30)                                                                                                                                                                                                                                  |
...
| `Croquis.scopes`                       |       78 |  119 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/6), `vize_canon` (41/43), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_patina` (2/15), `vize_ricalco` (0/5)                                                                                                                                                                                                                        |
