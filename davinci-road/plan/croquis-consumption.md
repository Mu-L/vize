...
| `Span`                                 |        0 |  505 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/63), `vize_atelier_sfc` (0/6), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/71), `vize_davinci` (0/20), `vize_disegno` (0/86), `vize_maestro` (0/4), `vize_patina` (0/143), `vize_relief` (0/8), `vize_ricalco` (0/45)                                                                                                           |
| `SpreadProp`                           |        5 |    9 | `vize_canon` (5/9)                                                                                                                                                                                                                                                                                                                                                                                     |
| `Symbol`                               |        0 |   66 | `vize_atelier_core` (0/5), `vize_atelier_sfc` (0/3), `vize_atelier_ssr` (0/2), `vize_canon` (0/3), `vize_croquis_cf` (0/27), `vize_fresco` (0/2), `vize_maestro` (0/1), `vize_patina` (0/15), `vize_relief` (0/5), `vize_vitrine` (0/3)                                                                                                                                                                |
...
| `Croquis.bindings`                     |       76 |  443 | `vize` (0/2), `vize_atelier_core` (2/24), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (43/88), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_disegno` (0/20), `vize_fresco` (0/6), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_ricalco` (0/21), `vize_vitrine` (2/7) |
