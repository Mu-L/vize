...
| `Analyzer`                             | type  | `analyzer`          | `vize_canon`        |    40 |   154 |
...
| `AnalyzerOptions`                      | type  | `analyzer`          | `vize_canon`        |    40 |   150 |
...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    69 |   170 |
...
| `PassedProp`                           | type  | `croquis::template` | `vize_canon`        |     9 |    21 |
...
| `Croquis.macros`                       | field | `croquis`           | `vize_canon`        |    23 |    73 |
...
| -------------------------------------- | -------: | ---: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Analyzer`                             |      198 |  291 | `vize` (1/2), `vize_canon` (154/234), `vize_croquis_cf` (40/49), `vize_doctor` (0/1), `vize_maestro` (2/3), `vize_vitrine` (1/2)                                                                                                                                                                                                                                                                                                                         |
| `AnalyzerOptions`                      |      173 |  292 | `vize` (1/2), `vize_canon` (150/230), `vize_croquis_cf` (19/56), `vize_maestro` (2/3)                                                                                                                                                                                                                                                                                                                                                                    |
...
| `Croquis`                              |      359 |  567 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (170/247), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/18), `vize_patina` (22/47), `vize_vitrine` (1/4)                                                                                                                                |
...
| `ScopeKind`                            |      110 |  135 | `vize_atelier_core` (1/2), `vize_atelier_sfc` (2/3), `vize_canon` (36/47), `vize_croquis_cf` (21/25), `vize_maestro` (43/49), `vize_patina` (3/5)                                                                                                                                                                                                                                                                                                        |
| `SlotUsage`                            |        7 |   17 | `vize_canon` (1/3), `vize_croquis_cf` (3/8), `vize_maestro` (3/6)                                                                                                                                                                                                                                                                                                                                                                                        |
| `Span`                                 |        0 |  657 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/73), `vize_atelier_sfc` (0/6), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/89), `vize_davinci` (0/20), `vize_maestro` (0/4), `vize_patina` (0/154), `vize_relief` (0/8), `vize_s1_to_s2` (0/127), `vize_s2` (0/117)                                                                                                                                                               |
...
| `Croquis.bindings`                     |       78 |  688 | `vize` (0/2), `vize_atelier_core` (2/24), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (1/36), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (45/90), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/227), `vize_s2` (0/21), `vize_vitrine` (2/7) |
...
| `Croquis.macros`                       |      148 |  268 | `vize_atelier_sfc` (11/102), `vize_canon` (73/75), `vize_croquis_cf` (25/27), `vize_davinci` (0/4), `vize_maestro` (14/24), `vize_musea` (0/2), `vize_patina` (22/31)                                                                                                                                                                                                                                                                                    |
...
| `Croquis.scopes`                       |       83 |  142 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/11), `vize_canon` (41/43), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_patina` (4/25), `vize_s1_to_s2` (0/10)                                                                                                                                                                                                                                                                       |
