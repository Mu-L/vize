...
| `ComponentUsage`                       | type  | `croquis::template` | `vize_canon`        |    13 |    34 |
...
| `Croquis.macros`                       | field | `croquis`           | `vize_maestro`      |     7 |    13 |
...
| `BlockLocation`                              | `vize_atelier_sfc`   |     2 |     3 |
...
| `SfcDescriptor`                              | `vize_canon`         |     9 |    14 |
| `SfcDescriptor`                              | `vize_maestro`       |     6 |    23 |
| `SfcDescriptor`                              | `vize_patina`        |     9 |    13 |
...
| `SfcTemplateBlock`                           | `vize_atelier_sfc`   |     4 |     6 |
...
| -------------------------------------- | -------: | ---: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Analyzer`                             |      183 |  271 | `vize_canon` (140/216), `vize_croquis_cf` (40/49), `vize_doctor` (0/1), `vize_maestro` (2/3), `vize_vitrine` (1/2)                                                                                                                                                                                                                                                                                 |
| `AnalyzerOptions`                      |      158 |  272 | `vize_canon` (136/212), `vize_croquis_cf` (19/56), `vize_maestro` (2/3)                                                                                                                                                                                                                                                                                                                            |
| `BindingMetadata`                      |       37 |  127 | `vize_atelier_core` (0/24), `vize_atelier_dom` (0/16), `vize_atelier_jsx` (1/2), `vize_atelier_sfc` (31/49), `vize_atelier_ssr` (0/2), `vize_atelier_vapor` (0/14), `vize_canon` (5/8), `vize_relief` (0/6), `vize_vitrine` (0/6)                                                                                                                                                                  |
| `COMPILER_MACRO_NAMES`                 |        1 |    3 | `vize_canon` (0/1), `vize_patina` (1/2)                                                                                                                                                                                                                                                                                                                                                            |
| `ComponentShape`                       |        1 |    2 | `vize_maestro` (1/2)                                                                                                                                                                                                                                                                                                                                                                               |
| `ComponentUsage`                       |       77 |  140 | `vize_canon` (34/47), `vize_croquis_cf` (38/85), `vize_maestro` (5/8)                                                                                                                                                                                                                                                                                                                              |
...
| `Scope`                                |       17 |   84 | `vize` (0/1), `vize_atelier_core` (0/3), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (0/1), `vize_atelier_sfc` (0/5), `vize_atelier_ssr` (0/3), `vize_canon` (17/48), `vize_davinci` (0/1), `vize_maestro` (0/7), `vize_patina` (0/6), `vize_relief` (0/2), `vize_ricalco` (0/3), `vize_s2` (0/1), `vize_vitrine` (0/2)                                                                           |
| `ScopeBinding`                         |        1 |   23 | `vize_atelier_core` (1/2), `vize_ricalco` (0/12), `vize_s2` (0/9)                                                                                                                                                                                                                                                                                                                                  |
...
| `ScopeKind`                            |      105 |  127 | `vize_atelier_core` (1/2), `vize_canon` (36/47), `vize_croquis_cf` (21/25), `vize_maestro` (43/49)                                                                                                                                                                                                                                                                                                 |
| `SlotUsage`                            |        7 |   17 | `vize_canon` (1/3), `vize_croquis_cf` (3/8), `vize_maestro` (3/6)                                                                                                                                                                                                                                                                                                                                  |
| `Span`                                 |        0 |  565 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/63), `vize_atelier_sfc` (0/6), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/89), `vize_davinci` (0/20), `vize_maestro` (0/4), `vize_patina` (0/143), `vize_relief` (0/8), `vize_ricalco` (0/66), `vize_s2` (0/107)                                                                                                           |
...
| `Croquis.bindings`                     |       76 |  531 | `vize` (0/2), `vize_atelier_core` (2/24), `vize_atelier_sfc` (16/224), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (43/88), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_ricalco` (0/109), `vize_s2` (0/21), `vize_vitrine` (2/7) |
| `Croquis.component_usages`             |       52 |   57 | `vize_croquis_cf` (33/38)                                                                                                                                                                                                                                                                                                                                                                          |
| `Croquis.hoists`                       |        0 |   15 | `vize_atelier_core` (0/8), `vize_atelier_sfc` (0/2), `vize_relief` (0/1), `vize_ricalco` (0/4)                                                                                                                                                                                                                                                                                                     |
| `Croquis.import_statements`            |        9 |   11 | `vize_maestro` (0/1), `vize_musea` (0/1)                                                                                                                                                                                                                                                                                                                                                           |
| `Croquis.macros`                       |      131 |  251 | `vize_atelier_sfc` (11/102), `vize_canon` (58/60), `vize_croquis_cf` (25/27), `vize_davinci` (0/4), `vize_maestro` (13/23), `vize_musea` (0/2), `vize_patina` (21/30)                                                                                                                                                                                                                              |
...
| `Croquis.scopes`                       |       79 |  124 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/6), `vize_canon` (41/43), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_patina` (2/15), `vize_ricalco` (0/9)                                                                                                                                                                                                                    |
