...
| `Span`                                 |        0 |  369 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/63), `vize_atelier_sfc` (0/5), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/71), `vize_davinci` (0/20), `vize_maestro` (0/2), `vize_patina` (0/141), `vize_relief` (0/8)                                                                                                           |
...
| `Croquis.bindings`                     |       75 |  402 | `vize` (0/2), `vize_atelier_core` (2/26), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (43/87), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_maestro` (8/12), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_vitrine` (2/7) |
