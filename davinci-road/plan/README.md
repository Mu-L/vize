...
| [phase-2.md](./phase-2.md) + [phase-2-tasks.md](./phase-2-tasks.md) + [phase-2-records.md](./phase-2-records.md) | Disegno and the pass manager                                                                    | **Executing since 2026-08-19** — re-cut 2026-08-17 at the P1 exit with all 20 IDs expanded to the full contract (P2-5 and P2-12 split into a/b, 22 tasks). **Current ledger (2026-08-28): 16 of 22 complete; 2 active and blocked (P2-9, P2-11); 4 untouched and dependency-blocked (P2-12b, P2-16, P2-17, P2-20).** P2-11 has 32 landed installments through [#5198](https://github.com/ubugeeei-prod/vize/pull/5198). Corpus scope is the executable inventory: 146 gitlinks / 142 ecosystem projects. The phase file owns the current ledger and exit gate; the records index separates current evidence from historical task records. |
