...
The four library trees in the reviewed inventory contain 56 production files,
68 direct `alloc::vec::Vec` paths, and 233 bound `Vec`/`StdVec` uses. "Direct"
...
| emit     |    12 |           12 |         61 | Ordered output buffers and collected emission inputs grow with the document.                                       |
...
| s1_to_s2 | `alloc::vec::Vec`       |    36 |           36 |        151 |
| s1_to_s2 | `alloc::string::String` |     0 |            0 |          0 |
| s1_to_s2 | `vize_s0::String`       |    49 |           51 |        215 |
