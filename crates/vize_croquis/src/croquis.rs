...
//! semantic facts drawn from a Vue SFC. It serves as the bridge between
...
/// Complete semantic croquis for a Vue SFC.
///
/// This struct aggregates all drawn semantic facts and provides a unified
