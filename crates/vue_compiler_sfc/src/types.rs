...
pub struct SfcParseOptions {
    ...
    pub template_parse_options: Option<vue_compiler_core::options::ParserOptions>,
}
...
pub struct TemplateCompileOptions {
    ...
    /// Compiler options
    pub compiler_options: Option<vue_compiler_dom::DomCompilerOptions>,
}
...
impl From<vue_compiler_core::CompilerError> for SfcError {
    fn from(err: vue_compiler_core::CompilerError) -> Self {
        Self {
            message: err.message,
