...
use vue_allocator::{Box, Bump, String};

use crate::ir::{DirectiveIRNode, OperationNode};
use vue_compiler_core::{DirectiveNode, ExpressionNode};
...
pub fn needs_transition(_el: &vue_compiler_core::ElementNode<'_>) -> bool {
