...
function configureMonaco() {
  ...
  // Define custom theme matching project CSS
  monaco.editor.defineTheme('vue-dark', {
    base: 'vs-dark',
    inherit: true,
    rules: [
      { token: 'keyword', foreground: '647eff' },
      { token: 'keyword.control.vue', foreground: '42d392', fontStyle: 'bold' },
      { token: 'support.function.vue', foreground: '42d392' },
      { token: 'attribute.name.vue', foreground: '647eff' },
      { token: 'variable', foreground: 'e4e4e7' },
      { token: 'tag', foreground: '647eff' },
      { token: 'attribute.name', foreground: 'a1a1aa' },
      { token: 'attribute.value', foreground: '42d392' },
      { token: 'string', foreground: '42d392' },
      { token: 'number', foreground: '647eff' },
    ...
    colors: {
      ...
      'editor.selectionBackground': '#647eff40',
      'editorCursor.foreground': '#42d392',
      'editorLineNumber.foreground': '#71717a',
      'editorLineNumber.activeForeground': '#a1a1aa',
      'editorIndentGuide.background': '#1a1a2e',
      'editorIndentGuide.activeBackground': '#647eff40',
      'editor.inactiveSelectionBackground': '#647eff20',
    },
  });
}
