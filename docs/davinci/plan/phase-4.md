...
| ---- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A    | P4-1a, P4-1b, P4-2        | `crates/vize_davinci/src/fact*`, `crates/vize_davinci/tests/fact_*`, `docs/davinci/plan/fact-alpha-schemas.md`                                                                                                                                                                  |
...
| D    | P4-6a, P4-6b, P4-6c       | `crates/vize_davinci/src/diagnostic*`, `crates/vize_davinci/src/witness*`, `crates/vize_patina/src/rule_contracts*`, `crates/vize_patina/src/output*`, `docs/davinci/plan/witness-exemptions.tsv`                                                                               |
...
| J    | P4-12a, P4-12b            | `crates/vize_glyph/`, `docs/davinci/plan/style-spec.md`                                                                                                                                                                                                                         |
