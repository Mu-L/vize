...
**Deliverable:** `docs/davinci/plan/style-spec.md`, written from charter #41's blank-slate discussion: every decision a numbered rule with a fixture pair `crates/vize_glyph/tests/style_spec/<rule-id>/{input,output}.vue` (the TS-41 set).
