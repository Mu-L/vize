...
| s1_to_s2 | `alloc::vec::Vec`       |    67 |           67 |        271 |
| s1_to_s2 | `alloc::string::String` |     0 |            0 |          0 |
| s1_to_s2 | `vize_s0::String`       |    97 |          105 |        482 |
| s1_to_s2 | `vize_s0::Vec`          |    18 |           20 |         69 |
| s1_to_s2 | `vize_s0::SmallVec`     |     5 |            5 |         12 |
