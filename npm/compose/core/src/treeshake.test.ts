...
const sentinels = {
  ...
  "use-storage": ["function useStorage(", "vize:storage"],
  ...
  "math-clamp": ["useClamp", "VIZE_COMPOSE_MATH_INVALID_RANGE"],
  "math-round": ["useRound", "VIZE_COMPOSE_MATH_INVALID_PRECISION"],
  "math-projection": ["useProjection"],
  "array-filter": ["useArrayFilter"],
  "array-map": ["useArrayMap"],
  "array-find": ["useArrayFind"],
  "array-reduce": ["useArrayReduce"],
  "array-some": ["useArraySome"],
  "array-every": ["useArrayEvery"],
  "array-unique": ["useArrayUnique"],
  ...
  "use-sorted": ["function useSorted("],
  "use-stepper": ["useStepper", "VIZE_COMPOSE_STEPPER_EMPTY"],
  "standard-schema": ["isStandardSchema"],
  "standard-schema-format": ["formatSchemaPath"],
  "standard-schema-validate": ["validateStandardSchema"],
  ...
  "use-queue": ["useQueue", "VIZE_COMPOSE_QUEUE_INVALID_CAPACITY"],
  "use-relative-time-format": ["useRelativeTimeFormat"],
  "use-relative-time-format-select": [
    "selectRelativeTimeUnit",
    "VIZE_COMPOSE_RELATIVE_TIME_INVALID_DIFF",
  ],
  "use-segmenter": ["useSegmenter", "VIZE_COMPOSE_SEGMENTER_INVALID_LENGTH"],
  "use-set": ["useSet"],
  "use-sorted-locale": ["useSortedLocale"],
  "use-stack": ["useStack", "VIZE_COMPOSE_STACK_INVALID_CAPACITY"],
  "use-barcode-detector": ["function useBarcodeDetector("],
  "use-bluetooth": ["function useBluetooth("],
  "use-contact-picker": ["function useContactPicker("],
  "use-gamepad--use-gamepad": ["function useGamepad("],
  "use-gamepad--map-gamepad": ["function mapGamepad("],
  "use-gamepad--snapshot-gamepad": ["function snapshotGamepad("],
  "use-hid": ["function useHID("],
  "use-payment-request": ["function usePaymentRequest("],
  "use-screen-details--use-screen-details": ["function useScreenDetails("],
  "use-screen-details--place-window": ["function placeWindow("],
  "use-screen-details--snapshot-screen": ["function snapshotScreen("],
  "use-serial": ["function useSerial("],
  "use-usb": ["function useUSB("],
  "use-user-activation": ["function useUserActivation("],
  "use-web-authn--use-web-authn": ["function useWebAuthn("],
  "use-web-authn--encode-base64-url": ["function encodeBase64Url("],
  "use-web-authn--decode-base64-url": ["function decodeBase64Url("],
  "use-web-authn--parse-creation-options-from-json": ["function parseCreationOptionsFromJSON("],
  "use-web-authn--parse-request-options-from-json": ["function parseRequestOptionsFromJSON("],
  "use-web-authn--serialize-registration-credential": ["function serializeRegistrationCredential("],
  "use-web-authn--serialize-authentication-credential": [
    "function serializeAuthenticationCredential(",
  ],
  "use-web-midi": ["function useWebMIDI("],
  "use-builtin-ai--use-translator": ["function useTranslator("],
  "use-builtin-ai--use-language-detector": ["function useLanguageDetector("],
  "use-builtin-ai--use-summarizer": ["function useSummarizer("],
  "use-compression-stream--compress": ["function compress("],
  "use-compression-stream--decompress": ["function decompress("],
  "use-compression-stream--decompress-text": ["function decompressText("],
  "use-compression-stream--use-compression-stream": ["function useCompressionStream("],
  "use-navigation-api": ["function useNavigationApi("],
  "use-performance-observer": ["function usePerformanceObserver("],
  "use-push-subscription": ["function usePushSubscription("],
  "use-request-idle-callback--use-request-idle-callback": ["function useRequestIdleCallback("],
  "use-request-idle-callback--idle": ["function idle("],
  "use-scheduler-post-task": ["function useSchedulerPostTask("],
  "use-service-worker": ["function useServiceWorker("],
  "use-storage-estimate--use-storage-estimate": ["function useStorageEstimate("],
  "use-storage-estimate--use-persistent-storage": ["function usePersistentStorage("],
  "use-view-transition": ["function useViewTransition("],
...
const utilities: readonly UtilityCase[] = [
  ...
  { binding: "useClamp", entry: "index", module: "math-clamp", shared: [] },
  { binding: "useRound", entry: "index", module: "math-round", shared: [] },
  { binding: "useProjection", entry: "index", module: "math-projection", shared: [] },
  { binding: "useArrayFilter", entry: "index", module: "array-filter", shared: [] },
  { binding: "useArrayMap", entry: "index", module: "array-map", shared: [] },
  { binding: "useArrayFind", entry: "index", module: "array-find", shared: [] },
  { binding: "useArrayReduce", entry: "index", module: "array-reduce", shared: [] },
  { binding: "useArraySome", entry: "index", module: "array-some", shared: [] },
  { binding: "useArrayEvery", entry: "index", module: "array-every", shared: [] },
  { binding: "useArrayUnique", entry: "index", module: "array-unique", shared: [] },
  { binding: "useAsyncQueue", entry: "index", module: "use-async-queue", shared: [] },
  { binding: "useAsyncState", entry: "index", module: "use-async-state", shared: [] },
  {
    binding: "useConfirmDialog",
    entry: "index",
    module: "use-confirm-dialog",
    shared: ["create-event-hook", "scope"],
  },
  { binding: "useCycleList", entry: "index", module: "use-cycle-list", shared: [] },
  { binding: "useMachine", entry: "index", module: "use-machine", shared: [] },
  { binding: "useMemoize", entry: "index", module: "use-memoize", shared: [] },
  { binding: "useOffsetPagination", entry: "index", module: "use-offset-pagination", shared: [] },
  { binding: "useSelection", entry: "index", module: "use-selection", shared: [] },
  { binding: "useSorted", entry: "index", module: "use-sorted", shared: [] },
  { binding: "useStepper", entry: "index", module: "use-stepper", shared: [] },
  {
    binding: "isStandardSchema",
    entry: "index",
    module: "standard-schema",
    shared: [],
  },
  {
    binding: "formatSchemaPath",
    entry: "index",
    module: "standard-schema-format",
    shared: [],
  },
  {
    binding: "validateStandardSchema",
    entry: "index",
    module: "standard-schema-validate",
    shared: ["standard-schema-format"],
  },
  {
    binding: "useDateTimeFormat",
    entry: "index",
    module: "use-date-time-format",
    shared: ["locale"],
  },
  {
    binding: "useDisplayNames",
    entry: "index",
    module: "use-display-names",
    shared: ["locale"],
  },
  {
    binding: "useField",
    entry: "index",
    module: "use-field",
    shared: ["scope", "standard-schema", "standard-schema-validate", "standard-schema-format"],
  },
  {
    binding: "useForm",
    entry: "index",
  ...
  {
    binding: "useNumberFormat",
    entry: "index",
    module: "use-number-format",
    shared: ["locale"],
  },
  {
    binding: "usePluralRules",
    entry: "index",
    module: "use-plural-rules",
    shared: ["locale"],
  },
  {
    binding: "useQueue",
  ...
  {
    binding: "selectRelativeTimeUnit",
    entry: "index",
    module: "use-relative-time-format-select",
    shared: [],
  },
  {
    binding: "useRelativeTimeFormat",
    entry: "index",
    module: "use-relative-time-format",
    shared: ["locale", "use-relative-time-format-select"],
  },
  {
    binding: "useSegmenter",
    entry: "index",
    module: "use-segmenter",
    shared: ["locale"],
  },
  {
    binding: "useSet",
  ...
  {
    binding: "useSortedLocale",
    entry: "index",
    module: "use-sorted-locale",
    shared: ["locale"],
  },
  {
    binding: "useStack",
  ...
  {
    binding: "useBarcodeDetector",
    entry: "index",
    module: "use-barcode-detector",
    shared: ["scope", "use-raf-fn"],
  },
  { binding: "useBluetooth", entry: "index", module: "use-bluetooth", shared: ["scope"] },
  { binding: "useContactPicker", entry: "index", module: "use-contact-picker", shared: [] },
  {
    binding: "useGamepad",
    entry: "index",
    module: "use-gamepad--use-gamepad",
    shared: ["scope", "use-gamepad--map-gamepad", "use-gamepad--snapshot-gamepad", "use-raf-fn"],
  },
  {
    binding: "mapGamepad",
    entry: "index",
    module: "use-gamepad--map-gamepad",
    shared: ["scope", "use-raf-fn"],
  },
  {
    binding: "snapshotGamepad",
    entry: "index",
    module: "use-gamepad--snapshot-gamepad",
    shared: ["scope", "use-raf-fn"],
  },
  { binding: "useHID", entry: "index", module: "use-hid", shared: ["scope"] },
  {
    binding: "usePaymentRequest",
    entry: "index",
    module: "use-payment-request",
    shared: ["scope"],
  },
  {
    binding: "useScreenDetails",
    entry: "index",
    module: "use-screen-details--use-screen-details",
    shared: ["scope", "use-screen-details--place-window", "use-screen-details--snapshot-screen"],
  },
  {
    binding: "placeWindow",
    entry: "index",
    module: "use-screen-details--place-window",
    shared: ["scope"],
  },
  {
    binding: "snapshotScreen",
    entry: "index",
    module: "use-screen-details--snapshot-screen",
    shared: ["scope"],
  },
  { binding: "useSerial", entry: "index", module: "use-serial", shared: ["scope"] },
  { binding: "useUSB", entry: "index", module: "use-usb", shared: ["scope"] },
  {
    binding: "useUserActivation",
    entry: "index",
    module: "use-user-activation",
    shared: ["scope"],
  },
  {
    binding: "useWebAuthn",
    entry: "index",
    module: "use-web-authn--use-web-authn",
    shared: [
      "scope",
      "use-web-authn--decode-base64-url",
      "use-web-authn--encode-base64-url",
      "use-web-authn--parse-creation-options-from-json",
      "use-web-authn--parse-request-options-from-json",
      "use-web-authn--serialize-authentication-credential",
      "use-web-authn--serialize-registration-credential",
    ],
  },
  {
    binding: "encodeBase64Url",
    entry: "index",
    module: "use-web-authn--encode-base64-url",
    shared: ["scope"],
  },
  {
    binding: "decodeBase64Url",
    entry: "index",
    module: "use-web-authn--decode-base64-url",
    shared: ["scope"],
  },
  {
    binding: "parseCreationOptionsFromJSON",
    entry: "index",
    module: "use-web-authn--parse-creation-options-from-json",
    shared: ["scope", "use-web-authn--decode-base64-url"],
  },
  {
    binding: "parseRequestOptionsFromJSON",
    entry: "index",
    module: "use-web-authn--parse-request-options-from-json",
    shared: ["scope", "use-web-authn--decode-base64-url"],
  },
  {
    binding: "serializeRegistrationCredential",
    entry: "index",
    module: "use-web-authn--serialize-registration-credential",
    shared: ["scope", "use-web-authn--encode-base64-url"],
  },
  {
    binding: "serializeAuthenticationCredential",
    entry: "index",
    module: "use-web-authn--serialize-authentication-credential",
    shared: ["scope", "use-web-authn--encode-base64-url"],
  },
  { binding: "useWebMIDI", entry: "index", module: "use-web-midi", shared: ["scope"] },
  {
    binding: "useTranslator",
    entry: "index",
    module: "use-builtin-ai--use-translator",
    shared: ["scope"],
  },
  {
    binding: "useLanguageDetector",
    entry: "index",
    module: "use-builtin-ai--use-language-detector",
    shared: ["scope"],
  },
  {
    binding: "useSummarizer",
    entry: "index",
    module: "use-builtin-ai--use-summarizer",
    shared: ["scope"],
  },
  { binding: "compress", entry: "index", module: "use-compression-stream--compress", shared: [] },
  {
    binding: "decompress",
    entry: "index",
    module: "use-compression-stream--decompress",
    shared: [],
  },
  {
    binding: "decompressText",
    entry: "index",
    module: "use-compression-stream--decompress-text",
    shared: ["use-compression-stream--decompress"],
  },
  {
    binding: "useCompressionStream",
    entry: "index",
    module: "use-compression-stream--use-compression-stream",
    shared: [
      "use-compression-stream--compress",
      "use-compression-stream--decompress",
      "use-compression-stream--decompress-text",
    ],
  },
  { binding: "useNavigationApi", entry: "index", module: "use-navigation-api", shared: ["scope"] },
  {
    binding: "usePerformanceObserver",
    entry: "index",
    module: "use-performance-observer",
    shared: ["scope"],
  },
  {
    binding: "usePushSubscription",
    entry: "index",
    module: "use-push-subscription",
    shared: ["scope"],
  },
  {
    binding: "useRequestIdleCallback",
    entry: "index",
    module: "use-request-idle-callback--use-request-idle-callback",
    shared: ["scope"],
  },
  { binding: "idle", entry: "index", module: "use-request-idle-callback--idle", shared: ["scope"] },
  {
    binding: "useSchedulerPostTask",
    entry: "index",
    module: "use-scheduler-post-task",
    shared: ["scope"],
  },
  { binding: "useServiceWorker", entry: "index", module: "use-service-worker", shared: ["scope"] },
  {
    binding: "useStorageEstimate",
    entry: "index",
    module: "use-storage-estimate--use-storage-estimate",
    shared: ["scope"],
  },
  {
    binding: "usePersistentStorage",
    entry: "index",
    module: "use-storage-estimate--use-persistent-storage",
    shared: ["scope"],
  },
  {
    binding: "useViewTransition",
    entry: "index",
    module: "use-view-transition",
    shared: ["media-query", "scope"],
  },
  { binding: "useWebLocks", entry: "index", module: "use-web-locks", shared: ["scope"] },
  {
    binding: "useWebVitals",
    entry: "index",
    module: "use-web-vitals--use-web-vitals",
    shared: ["scope", "use-performance-observer", "use-web-vitals--rate-metric"],
  },
  {
    binding: "rateMetric",
    entry: "index",
